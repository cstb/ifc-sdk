...
bool IfcExternallyDefinedTextFont::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcExternallyDefinedTextFont::s_type("IfcExternallyDefinedTextFont","IfcExternalReference");
