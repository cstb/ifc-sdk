...
bool IfcFlowFittingType::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcFlowFittingType::s_type("IfcFlowFittingType","IfcDistributionFlowElementType");
