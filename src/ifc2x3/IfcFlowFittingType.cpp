...
IfcFlowFittingType::IfcFlowFittingType(Step::SPFData *args) : IfcDistributionFlowElementType(args) {
}
...
const char *IfcFlowFittingType::type() {
...
IFC2X3_DLL_DEF Step::ClassType IfcFlowFittingType::s_type = new Step::ClassType_class("IfcFlowFittingType");
