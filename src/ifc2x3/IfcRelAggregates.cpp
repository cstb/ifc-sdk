...
IfcRelAggregates::IfcRelAggregates(Step::Id id, Step::SPFData *args) : 
    IfcRelDecomposes(id, args)
{
}
...
{
    if (IfcRelDecomposes::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcRelAggregates, IfcRelDecomposes)
