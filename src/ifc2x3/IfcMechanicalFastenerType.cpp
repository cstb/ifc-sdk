...
IfcMechanicalFastenerType::IfcMechanicalFastenerType(Step::Id id, Step::SPFData *args) : 
    IfcFastenerType(id, args)
{
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcMechanicalFastenerType, IfcFastenerType)
