...
bool IfcRelConnectsPortToElement::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcRelConnectsPortToElement::s_type("IfcRelConnectsPortToElement","IfcRelConnects");
