...
IfcVertexPoint::IfcVertexPoint(Step::Id id, Step::SPFData *args) : 
    IfcVertex(id, args)
{
...
{
    return const_cast<IfcVertexPoint *>(this)->getVertexGeometry();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcVertexPoint, IfcVertex)
