...
bool IfcCraneRailAShapeProfileDef::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcCraneRailAShapeProfileDef::s_type("IfcCraneRailAShapeProfileDef","IfcParameterizedProfileDef");
