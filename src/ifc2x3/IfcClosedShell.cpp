...
IfcClosedShell::IfcClosedShell(Step::Id id, Step::SPFData *args) : 
    IfcConnectedFaceSet(id, args)
{
}
...
{
    if (IfcConnectedFaceSet::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcClosedShell, IfcConnectedFaceSet)
