...
IfcPreDefinedPointMarkerSymbol::IfcPreDefinedPointMarkerSymbol(Step::Id id, Step::SPFData *args) : 
    IfcPreDefinedSymbol(id, args)
{
}
...
{
    if (IfcPreDefinedSymbol::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcPreDefinedPointMarkerSymbol, IfcPreDefinedSymbol)
