...
IfcDistributionControlElementType::IfcDistributionControlElementType(Step::Id id, Step::SPFData *args) : 
    IfcDistributionElementType(id, args)
{
}
...
{
    if (IfcDistributionElementType::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcDistributionControlElementType, IfcDistributionElementType)
