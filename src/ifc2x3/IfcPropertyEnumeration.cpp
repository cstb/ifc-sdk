...
IfcPropertyEnumeration::IfcPropertyEnumeration(Step::Id id, Step::SPFData *args) : 
...
{
    return const_cast<IfcPropertyEnumeration *>(this)->getName();
}
...
{
    return const_cast<IfcPropertyEnumeration *>(this)->getEnumerationValues();
}
...
{
    return const_cast<IfcPropertyEnumeration *>(this)->getUnit();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcPropertyEnumeration, Step::BaseEntity)
