...
IfcPropertyEnumeration::IfcPropertyEnumeration(Step::SPFData *args) : Step::BaseObject(args) {
...
const char *IfcPropertyEnumeration::type() {
...
Step::StepList< Step::RefPtr< IfcValue > > &IfcPropertyEnumeration::getEnumerationValues() {
  if (Step::BaseObject::inited()) {
...
void IfcPropertyEnumeration::setEnumerationValues(const Step::StepList< Step::RefPtr< IfcValue > > &value) {
...
IFC2X3_DLL_DEF Step::ClassType IfcPropertyEnumeration::s_type = new Step::ClassType_class("IfcPropertyEnumeration");
IfcPropertyEnumeration_Factory::IfcPropertyEnumeration_Factory() {
}
...
void IfcPropertyEnumeration_Factory::clear(bool b) {
}

std::map<Step::StepId,Step::BaseObject*>::iterator IfcPropertyEnumeration_Factory::begin() {
  return m_idMap.begin();
}

std::map<Step::StepId,Step::BaseObject*>::iterator IfcPropertyEnumeration_Factory::end() {
  return m_idMap.end();
}

IfcPropertyEnumeration *IfcPropertyEnumeration_Factory::get(Step::StepId id) {
  IfcPropertyEnumeration *value;
  std::map<Step::StepId,Step::BaseObject*>::iterator it = m_idMap.find(id);
  if (it != m_idMap.end()) {
    value = static_cast< IfcPropertyEnumeration * > (it->second);
  }
  else {
    LOG_ERROR("IfcPropertyEnumeration_Factory::get() : Key not found.");
    return NULL;
  }
  if (value) {
    return value;
    ...
    return static_cast< IfcPropertyEnumeration * > (create(id));
  }
}

Step::BaseObject *IfcPropertyEnumeration_Factory::create(Step::StepId id) {
  IfcPropertyEnumeration *ret = new IfcPropertyEnumeration(m_model->getArgs(id));
  ret->set_key(id);
...
Step::BaseObject *IfcPropertyEnumeration_Factory::create(STEP_MAP<Step::StepId, Step::BaseObjectPtr >::iterator it) {
  IfcPropertyEnumeration *ret = new IfcPropertyEnumeration(it->second->getArgs());
...
Step::BaseObject *IfcPropertyEnumeration_Factory::create(std::map<Step::StepId, Step::BaseObject*>::iterator it) {
  IfcPropertyEnumeration *ret = new IfcPropertyEnumeration(m_model->getArgs(it->first));
  ret->set_key(it->first);
  m_model->registerObject(it->first, ret);
  it->second = ret;
  return ret;
...
IfcPropertyEnumeration *IfcPropertyEnumeration_Factory::generate() {
  return static_cast< IfcPropertyEnumeration * > (create(m_model->getNewId()));
}

IfcPropertyEnumeration *IfcPropertyEnumeration_Factory::find(Step::StepId id) {
  std::map<Step::StepId,Step::BaseObject*>::iterator it = m_idMap.find(id);
  if (it != m_idMap.end()) {
    return static_cast< IfcPropertyEnumeration * > (it->second);
  }
  else {
    return NULL;
  }
