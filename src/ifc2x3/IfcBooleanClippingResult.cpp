...
IfcBooleanClippingResult::IfcBooleanClippingResult(Step::Id id, Step::SPFData *args) : 
    IfcBooleanResult(id, args)
{
}
...
{
    if (IfcBooleanResult::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcBooleanClippingResult, IfcBooleanResult)
