...
IfcDimensionCurveDirectedCallout::IfcDimensionCurveDirectedCallout(Step::Id id, Step::SPFData *args) : 
    IfcDraughtingCallout(id, args)
{
}
...
{
    if (IfcDraughtingCallout::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcDimensionCurveDirectedCallout, IfcDraughtingCallout)
