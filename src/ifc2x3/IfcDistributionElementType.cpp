...
bool IfcDistributionElementType::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcDistributionElementType::s_type("IfcDistributionElementType","IfcElementType");
