...
IfcVibrationIsolatorType::IfcVibrationIsolatorType(Step::Id id, Step::SPFData *args) : 
    IfcDiscreteAccessoryType(id, args)
{
...
IfcVibrationIsolatorTypeEnum IfcVibrationIsolatorType::getPredefinedType() const
{
    return const_cast<IfcVibrationIsolatorType *>(this)->getPredefinedType();
}
...
{
    if (IfcDiscreteAccessoryType::init() == false)
    {
        return false;
    }
    std::string arg;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcVibrationIsolatorType, IfcDiscreteAccessoryType)
