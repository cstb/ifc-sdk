...
bool IfcFlowTreatmentDevice::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcFlowTreatmentDevice::s_type("IfcFlowTreatmentDevice","IfcDistributionFlowElement");
