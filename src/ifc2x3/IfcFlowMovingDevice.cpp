...
bool IfcFlowMovingDevice::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcFlowMovingDevice::s_type("IfcFlowMovingDevice","IfcDistributionFlowElement");
