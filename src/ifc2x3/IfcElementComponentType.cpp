...
IfcElementComponentType::IfcElementComponentType(Step::SPFData *args) : IfcElementType(args) {
}
...
const char *IfcElementComponentType::type() {
...
IFC2X3_DLL_DEF Step::ClassType IfcElementComponentType::s_type = new Step::ClassType_class("IfcElementComponentType");
