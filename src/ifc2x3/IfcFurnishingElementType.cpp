...
bool IfcFurnishingElementType::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcFurnishingElementType::s_type("IfcFurnishingElementType","IfcElementType");
