...
IfcStyledRepresentation::IfcStyledRepresentation(Step::Id id, Step::SPFData *args) : 
    IfcStyleModel(id, args)
{
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcStyledRepresentation, IfcStyleModel)
