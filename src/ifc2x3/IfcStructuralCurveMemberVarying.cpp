...
IfcStructuralCurveMemberVarying::IfcStructuralCurveMemberVarying(Step::Id id, Step::SPFData *args) : 
    IfcStructuralCurveMember(id, args)
{
}
...
{
    if (IfcStructuralCurveMember::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcStructuralCurveMemberVarying, IfcStructuralCurveMember)
