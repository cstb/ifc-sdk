...
IfcBoundaryCondition::IfcBoundaryCondition(Step::Id id, Step::SPFData *args) : 
...
{
    return const_cast<IfcBoundaryCondition *>(this)->getName();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcBoundaryCondition, Step::BaseEntity)
