...
IfcMotorConnectionType::IfcMotorConnectionType(Step::Id id, Step::SPFData *args) : 
...
IfcMotorConnectionTypeEnum IfcMotorConnectionType::getPredefinedType() const
{
    return const_cast<IfcMotorConnectionType *>(this)->getPredefinedType();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcMotorConnectionType, IfcEnergyConversionDeviceType)
