...
IfcBuildingElement::IfcBuildingElement(Step::SPFData *args) : IfcElement(args) {
}
...
const char *IfcBuildingElement::type() {
...
IFC2X3_DLL_DEF Step::ClassType IfcBuildingElement::s_type = new Step::ClassType_class("IfcBuildingElement");
