...
IfcStructuralLoad::IfcStructuralLoad(Step::SPFData *args) : Step::BaseObject(args) {
...
const char *IfcStructuralLoad::type() {
...
IFC2X3_DLL_DEF Step::ClassType IfcStructuralLoad::s_type = new Step::ClassType_class("IfcStructuralLoad");
