...
IfcSimpleProperty::IfcSimpleProperty(Step::SPFData *args) : IfcProperty(args) {
}
...
const char *IfcSimpleProperty::type() {
...
IFC2X3_DLL_DEF Step::ClassType IfcSimpleProperty::s_type = new Step::ClassType_class("IfcSimpleProperty");
