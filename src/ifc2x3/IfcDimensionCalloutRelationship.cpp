...
IfcDimensionCalloutRelationship::IfcDimensionCalloutRelationship(Step::Id id, Step::SPFData *args) : 
    IfcDraughtingCalloutRelationship(id, args)
{
}
...
{
    if (IfcDraughtingCalloutRelationship::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcDimensionCalloutRelationship, IfcDraughtingCalloutRelationship)
