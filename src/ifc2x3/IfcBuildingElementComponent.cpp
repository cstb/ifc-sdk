...
bool IfcBuildingElementComponent::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcBuildingElementComponent::s_type("IfcBuildingElementComponent","IfcBuildingElement");
