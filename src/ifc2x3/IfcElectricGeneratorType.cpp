...
IfcElectricGeneratorType::IfcElectricGeneratorType(Step::Id id, Step::SPFData *args) : 
...
IfcElectricGeneratorTypeEnum IfcElectricGeneratorType::getPredefinedType() const
{
    return const_cast<IfcElectricGeneratorType *>(this)->getPredefinedType();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcElectricGeneratorType, IfcEnergyConversionDeviceType)
