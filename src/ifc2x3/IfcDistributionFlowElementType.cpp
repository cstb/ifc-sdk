...
bool IfcDistributionFlowElementType::init(Step::InstanciateIf *instanciateIf) {
    bool status = IfcDistributionElementType::init(instanciateIf);
    std::string arg;
    if (!status) {
        return false;
    }
...
IFC2X3_EXPORT Step::ClassType IfcDistributionFlowElementType::s_type("IfcDistributionFlowElementType","IfcDistributionElementType");
