...
bool IfcRelConnectsStructuralElement::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcRelConnectsStructuralElement::s_type("IfcRelConnectsStructuralElement","IfcRelConnects");
