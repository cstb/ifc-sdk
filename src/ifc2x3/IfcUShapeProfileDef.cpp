...
bool IfcUShapeProfileDef::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcUShapeProfileDef::s_type("IfcUShapeProfileDef","IfcParameterizedProfileDef");
