...
bool IfcAirTerminalType::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcAirTerminalType::s_type("IfcAirTerminalType","IfcFlowTerminalType");
