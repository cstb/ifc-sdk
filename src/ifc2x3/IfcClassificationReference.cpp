...
IfcClassificationReference::IfcClassificationReference(Step::Id id, Step::SPFData *args) : 
...
{
    return const_cast<IfcClassificationReference *>(this)->getReferencedSource();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcClassificationReference, IfcExternalReference)
