...
IfcPerformanceHistory::IfcPerformanceHistory(Step::Id id, Step::SPFData *args) : 
    IfcControl(id, args)
{
...
{
    return const_cast<IfcPerformanceHistory *>(this)->getLifeCyclePhase();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcPerformanceHistory, IfcControl)
