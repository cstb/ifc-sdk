...
IfcTimeSeriesValue::IfcTimeSeriesValue(Step::Id id, Step::SPFData *args) : 
...
{
    return const_cast<IfcTimeSeriesValue *>(this)->getListValues();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcTimeSeriesValue, Step::BaseEntity)
