...
IfcTimeSeriesValue::IfcTimeSeriesValue(Step::SPFData *args) : Step::BaseObject(args) {
...
bool IfcTimeSeriesValue::acceptVisitor(Step::BaseVisitor *v) {
  return static_cast< Visitor * > (v)->visitIfcTimeSeriesValue(this);
}

const char *IfcTimeSeriesValue::type() {
  return "IfcTimeSeriesValue";
}

Step::ClassType IfcTimeSeriesValue::getClassType() {
  return IfcTimeSeriesValue::s_type;
}

Step::ClassType IfcTimeSeriesValue::getType() const {
  return IfcTimeSeriesValue::s_type;
}

bool IfcTimeSeriesValue::isOfType(Step::ClassType t) {
  return IfcTimeSeriesValue::s_type == t ? true : Step::BaseObject::isOfType(t);
}

Step::StepList< Step::RefPtr< IfcValue > > &IfcTimeSeriesValue::getListValues() {
...
void IfcTimeSeriesValue::setListValues(const Step::StepList< Step::RefPtr< IfcValue > > &value) {
  m_listValues = value;
}

void IfcTimeSeriesValue::release() {
  m_listValues.clear();
}
...
IFC2X3_DLL_DEF Step::ClassType IfcTimeSeriesValue::s_type = new Step::ClassType_class("IfcTimeSeriesValue");
IfcTimeSeriesValue_Factory::IfcTimeSeriesValue_Factory() {
}
...
void IfcTimeSeriesValue_Factory::clear(bool b) {
}

std::map<Step::StepId,Step::BaseObject*>::iterator IfcTimeSeriesValue_Factory::begin() {
  return m_idMap.begin();
}

std::map<Step::StepId,Step::BaseObject*>::iterator IfcTimeSeriesValue_Factory::end() {
  return m_idMap.end();
}

IfcTimeSeriesValue *IfcTimeSeriesValue_Factory::get(Step::StepId id) {
  IfcTimeSeriesValue *value;
  std::map<Step::StepId,Step::BaseObject*>::iterator it = m_idMap.find(id);
  if (it != m_idMap.end()) {
    value = static_cast< IfcTimeSeriesValue * > (it->second);
  }
  else {
    LOG_ERROR("IfcTimeSeriesValue_Factory::get() : Key not found.");
    return NULL;
  }
  if (value) {
    return value;
    ...
    return static_cast< IfcTimeSeriesValue * > (create(id));
  }
}

Step::BaseObject *IfcTimeSeriesValue_Factory::create(Step::StepId id) {
  IfcTimeSeriesValue *ret = new IfcTimeSeriesValue(m_model->getArgs(id));
  ret->set_key(id);
...
Step::BaseObject *IfcTimeSeriesValue_Factory::create(STEP_MAP<Step::StepId, Step::BaseObjectPtr >::iterator it) {
  IfcTimeSeriesValue *ret = new IfcTimeSeriesValue(it->second->getArgs());
...
Step::BaseObject *IfcTimeSeriesValue_Factory::create(std::map<Step::StepId, Step::BaseObject*>::iterator it) {
  IfcTimeSeriesValue *ret = new IfcTimeSeriesValue(m_model->getArgs(it->first));
  ret->set_key(it->first);
  m_model->registerObject(it->first, ret);
  it->second = ret;
  return ret;
...
IfcTimeSeriesValue *IfcTimeSeriesValue_Factory::generate() {
  return static_cast< IfcTimeSeriesValue * > (create(m_model->getNewId()));
}

IfcTimeSeriesValue *IfcTimeSeriesValue_Factory::find(Step::StepId id) {
  std::map<Step::StepId,Step::BaseObject*>::iterator it = m_idMap.find(id);
  if (it != m_idMap.end()) {
    return static_cast< IfcTimeSeriesValue * > (it->second);
  }
  else {
    return NULL;
  }
