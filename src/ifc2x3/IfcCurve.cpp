...
IfcCurve::IfcCurve(Step::SPFData *args) : IfcGeometricRepresentationItem(args) {
}
...
IFC2X3_DLL_DEF Step::ClassType IfcCurve::s_type = new Step::ClassType_class("IfcCurve");
