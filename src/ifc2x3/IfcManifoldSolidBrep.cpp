...
IfcManifoldSolidBrep::IfcManifoldSolidBrep(Step::SPFData *args) : IfcSolidModel(args) {
  m_outer = NULL;
}
...
const char *IfcManifoldSolidBrep::type() {
...
bool IfcManifoldSolidBrep::init() {
  ...
  if (arg == "$" || arg == "*") {
    ...
    m_outer = static_cast< IfcClosedShell * > (m_model->getObjectById(atoi(arg.c_str() + 1)));
  }
  return true;
}

IFC2X3_DLL_DEF Step::ClassType IfcManifoldSolidBrep::s_type = new Step::ClassType_class("IfcManifoldSolidBrep");
