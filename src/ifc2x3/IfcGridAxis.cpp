...
bool IfcGridAxis::init() {
    ...
    if (inverses) {
        unsigned int i;
        m_partOfW = new Inverse_Set_IfcGrid_0_1;
    ...
    if (inverses) {
        unsigned int i;
        m_partOfV = new Inverse_Set_IfcGrid_0_1;
    ...
    if (inverses) {
        unsigned int i;
        m_partOfU = new Inverse_Set_IfcGrid_0_1;
    ...
    if (inverses) {
        unsigned int i;
        m_hasIntersections = new Inverse_Set_IfcVirtualGridIntersection_0_n;
