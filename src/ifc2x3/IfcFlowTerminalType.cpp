...
bool IfcFlowTerminalType::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcFlowTerminalType::s_type("IfcFlowTerminalType","IfcDistributionFlowElementType");
