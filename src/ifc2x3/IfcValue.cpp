...
void IfcValue::copy(const IfcValue &obj, const CopyOp &copyop)
{
    ...
    case IFCVOLUMEMEASURE :
        setIfcVolumeMeasure(obj.m_union.m_IfcVolumeMeasure);
        break;
    case IFCTIMEMEASURE :
        setIfcTimeMeasure(obj.m_union.m_IfcTimeMeasure);
        break;
    case IFCTHERMODYNAMICTEMPERATUREMEASURE :
        setIfcThermodynamicTemperatureMeasure(obj.m_union.m_IfcThermodynamicTemperatureMeasure);
        break;
    case IFCSOLIDANGLEMEASURE :
        setIfcSolidAngleMeasure(obj.m_union.m_IfcSolidAngleMeasure);
        break;
    case IFCPOSITIVERATIOMEASURE :
        setIfcPositiveRatioMeasure(obj.m_union.m_IfcPositiveRatioMeasure);
        break;
    case IFCRATIOMEASURE :
        setIfcRatioMeasure(obj.m_union.m_IfcRatioMeasure);
        break;
    case IFCPOSITIVEPLANEANGLEMEASURE :
        setIfcPositivePlaneAngleMeasure(obj.m_union.m_IfcPositivePlaneAngleMeasure);
        break;
    ...
    case IFCNUMERICMEASURE :
        setIfcNumericMeasure(obj.m_union.m_IfcNumericMeasure);
        break;
    case IFCMASSMEASURE :
        setIfcMassMeasure(obj.m_union.m_IfcMassMeasure);
        break;
    case IFCPOSITIVELENGTHMEASURE :
        setIfcPositiveLengthMeasure(obj.m_union.m_IfcPositiveLengthMeasure);
        break;
    case IFCLENGTHMEASURE :
        setIfcLengthMeasure(obj.m_union.m_IfcLengthMeasure);
        break;
    case IFCELECTRICCURRENTMEASURE :
        setIfcElectricCurrentMeasure(obj.m_union.m_IfcElectricCurrentMeasure);
        break;
    case IFCDESCRIPTIVEMEASURE :
        setIfcDescriptiveMeasure(*obj.m_union.m_IfcDescriptiveMeasure);
        break;
    case IFCCOUNTMEASURE :
        setIfcCountMeasure(obj.m_union.m_IfcCountMeasure);
        break;
    case IFCCONTEXTDEPENDENTMEASURE :
        setIfcContextDependentMeasure(obj.m_union.m_IfcContextDependentMeasure);
        break;
    case IFCAREAMEASURE :
        setIfcAreaMeasure(obj.m_union.m_IfcAreaMeasure);
        break;
    case IFCAMOUNTOFSUBSTANCEMEASURE :
        setIfcAmountOfSubstanceMeasure(obj.m_union.m_IfcAmountOfSubstanceMeasure);
        break;
    case IFCLUMINOUSINTENSITYMEASURE :
        setIfcLuminousIntensityMeasure(obj.m_union.m_IfcLuminousIntensityMeasure);
        break;
    ...
    case IFCCOMPLEXNUMBER :
        {
            IfcComplexNumber::const_iterator it_IfcComplexNumber;
            IfcComplexNumber::iterator it_current_IfcComplexNumber;
            for (it_IfcComplexNumber = obj.m_union.m_IfcComplexNumber->begin(), 
                 it_current_IfcComplexNumber = m_union.m_IfcComplexNumber->begin(); 
                 
                 it_IfcComplexNumber != obj.m_union.m_IfcComplexNumber->end(); 
                 
                 ++it_IfcComplexNumber, ++it_current_IfcComplexNumber) 
            {
                *it_current_IfcComplexNumber = (*it_IfcComplexNumber);
            }
            setIfcComplexNumber(obj.m_union.m_IfcComplexNumber);
        }
        break;
    case IFCINTEGER :
    ...
    case IFCVOLUMETRICFLOWRATEMEASURE :
        setIfcVolumetricFlowRateMeasure(obj.m_union.m_IfcVolumetricFlowRateMeasure);
        break;
    case IFCTIMESTAMP :
        setIfcTimeStamp(obj.m_union.m_IfcTimeStamp);
        break;
    case IFCTHERMALTRANSMITTANCEMEASURE :
        setIfcThermalTransmittanceMeasure(obj.m_union.m_IfcThermalTransmittanceMeasure);
        break;
    case IFCTHERMALRESISTANCEMEASURE :
        setIfcThermalResistanceMeasure(obj.m_union.m_IfcThermalResistanceMeasure);
        break;
    case IFCTHERMALADMITTANCEMEASURE :
        setIfcThermalAdmittanceMeasure(obj.m_union.m_IfcThermalAdmittanceMeasure);
        break;
    case IFCPRESSUREMEASURE :
        setIfcPressureMeasure(obj.m_union.m_IfcPressureMeasure);
        break;
    case IFCPOWERMEASURE :
        setIfcPowerMeasure(obj.m_union.m_IfcPowerMeasure);
        break;
    case IFCMASSFLOWRATEMEASURE :
        setIfcMassFlowRateMeasure(obj.m_union.m_IfcMassFlowRateMeasure);
        break;
    case IFCMASSDENSITYMEASURE :
        setIfcMassDensityMeasure(obj.m_union.m_IfcMassDensityMeasure);
        break;
    case IFCLINEARVELOCITYMEASURE :
        setIfcLinearVelocityMeasure(obj.m_union.m_IfcLinearVelocityMeasure);
        break;
    case IFCKINEMATICVISCOSITYMEASURE :
        setIfcKinematicViscosityMeasure(obj.m_union.m_IfcKinematicViscosityMeasure);
        break;
    case IFCINTEGERCOUNTRATEMEASURE :
        setIfcIntegerCountRateMeasure(obj.m_union.m_IfcIntegerCountRateMeasure);
        break;
    case IFCHEATFLUXDENSITYMEASURE :
        setIfcHeatFluxDensityMeasure(obj.m_union.m_IfcHeatFluxDensityMeasure);
        break;
    case IFCFREQUENCYMEASURE :
        setIfcFrequencyMeasure(obj.m_union.m_IfcFrequencyMeasure);
        break;
    case IFCENERGYMEASURE :
        setIfcEnergyMeasure(obj.m_union.m_IfcEnergyMeasure);
        break;
    case IFCELECTRICVOLTAGEMEASURE :
        setIfcElectricVoltageMeasure(obj.m_union.m_IfcElectricVoltageMeasure);
        break;
    case IFCDYNAMICVISCOSITYMEASURE :
        setIfcDynamicViscosityMeasure(obj.m_union.m_IfcDynamicViscosityMeasure);
        break;
    case IFCCOMPOUNDPLANEANGLEMEASURE :
        {
            IfcCompoundPlaneAngleMeasure::const_iterator it_IfcCompoundPlaneAngleMeasure;
            m_union.m_IfcCompoundPlaneAngleMeasure->clear();
            for (it_IfcCompoundPlaneAngleMeasure = obj.m_union.m_IfcCompoundPlaneAngleMeasure->begin(); 
                it_IfcCompoundPlaneAngleMeasure != obj.m_union.m_IfcCompoundPlaneAngleMeasure->end(); 
                ++it_IfcCompoundPlaneAngleMeasure) 
            {
                Step::Integer copyTarget = (*it_IfcCompoundPlaneAngleMeasure);
                m_union.m_IfcCompoundPlaneAngleMeasure->push_back(copyTarget);
            }
            setIfcCompoundPlaneAngleMeasure(obj.m_union.m_IfcCompoundPlaneAngleMeasure);
        }
        break;
    case IFCANGULARVELOCITYMEASURE :
        setIfcAngularVelocityMeasure(obj.m_union.m_IfcAngularVelocityMeasure);
        break;
    case IFCTHERMALCONDUCTIVITYMEASURE :
        setIfcThermalConductivityMeasure(obj.m_union.m_IfcThermalConductivityMeasure);
        break;
    case IFCMOLECULARWEIGHTMEASURE :
        setIfcMolecularWeightMeasure(obj.m_union.m_IfcMolecularWeightMeasure);
        break;
    case IFCVAPORPERMEABILITYMEASURE :
        setIfcVaporPermeabilityMeasure(obj.m_union.m_IfcVaporPermeabilityMeasure);
        break;
    case IFCMOISTUREDIFFUSIVITYMEASURE :
        setIfcMoistureDiffusivityMeasure(obj.m_union.m_IfcMoistureDiffusivityMeasure);
        break;
    case IFCISOTHERMALMOISTURECAPACITYMEASURE :
        setIfcIsothermalMoistureCapacityMeasure(obj.m_union.m_IfcIsothermalMoistureCapacityMeasure);
        break;
    case IFCSPECIFICHEATCAPACITYMEASURE :
        setIfcSpecificHeatCapacityMeasure(obj.m_union.m_IfcSpecificHeatCapacityMeasure);
        break;
    case IFCMONETARYMEASURE :
        setIfcMonetaryMeasure(obj.m_union.m_IfcMonetaryMeasure);
        break;
    case IFCMAGNETICFLUXDENSITYMEASURE :
        setIfcMagneticFluxDensityMeasure(obj.m_union.m_IfcMagneticFluxDensityMeasure);
        break;
    case IFCMAGNETICFLUXMEASURE :
        setIfcMagneticFluxMeasure(obj.m_union.m_IfcMagneticFluxMeasure);
        break;
    case IFCLUMINOUSFLUXMEASURE :
        setIfcLuminousFluxMeasure(obj.m_union.m_IfcLuminousFluxMeasure);
        break;
    case IFCFORCEMEASURE :
        setIfcForceMeasure(obj.m_union.m_IfcForceMeasure);
        break;
    case IFCINDUCTANCEMEASURE :
        setIfcInductanceMeasure(obj.m_union.m_IfcInductanceMeasure);
        break;
    case IFCILLUMINANCEMEASURE :
        setIfcIlluminanceMeasure(obj.m_union.m_IfcIlluminanceMeasure);
        break;
    case IFCELECTRICRESISTANCEMEASURE :
        setIfcElectricResistanceMeasure(obj.m_union.m_IfcElectricResistanceMeasure);
        break;
    case IFCELECTRICCONDUCTANCEMEASURE :
        setIfcElectricConductanceMeasure(obj.m_union.m_IfcElectricConductanceMeasure);
        break;
    case IFCELECTRICCHARGEMEASURE :
        setIfcElectricChargeMeasure(obj.m_union.m_IfcElectricChargeMeasure);
        break;
    case IFCDOSEEQUIVALENTMEASURE :
        setIfcDoseEquivalentMeasure(obj.m_union.m_IfcDoseEquivalentMeasure);
        break;
    case IFCELECTRICCAPACITANCEMEASURE :
        setIfcElectricCapacitanceMeasure(obj.m_union.m_IfcElectricCapacitanceMeasure);
        break;
    case IFCABSORBEDDOSEMEASURE :
        setIfcAbsorbedDoseMeasure(obj.m_union.m_IfcAbsorbedDoseMeasure);
        break;
    case IFCRADIOACTIVITYMEASURE :
        setIfcRadioActivityMeasure(obj.m_union.m_IfcRadioActivityMeasure);
        break;
    case IFCROTATIONALFREQUENCYMEASURE :
        setIfcRotationalFrequencyMeasure(obj.m_union.m_IfcRotationalFrequencyMeasure);
        break;
    case IFCTORQUEMEASURE :
        setIfcTorqueMeasure(obj.m_union.m_IfcTorqueMeasure);
        break;
    case IFCACCELERATIONMEASURE :
        setIfcAccelerationMeasure(obj.m_union.m_IfcAccelerationMeasure);
        break;
    case IFCLINEARFORCEMEASURE :
        setIfcLinearForceMeasure(obj.m_union.m_IfcLinearForceMeasure);
        break;
    case IFCLINEARSTIFFNESSMEASURE :
        setIfcLinearStiffnessMeasure(obj.m_union.m_IfcLinearStiffnessMeasure);
        break;
    case IFCMODULUSOFSUBGRADEREACTIONMEASURE :
        setIfcModulusOfSubgradeReactionMeasure(obj.m_union.m_IfcModulusOfSubgradeReactionMeasure);
        break;
    case IFCMODULUSOFELASTICITYMEASURE :
        setIfcModulusOfElasticityMeasure(obj.m_union.m_IfcModulusOfElasticityMeasure);
        break;
    case IFCMOMENTOFINERTIAMEASURE :
        setIfcMomentOfInertiaMeasure(obj.m_union.m_IfcMomentOfInertiaMeasure);
        break;
    case IFCPLANARFORCEMEASURE :
        setIfcPlanarForceMeasure(obj.m_union.m_IfcPlanarForceMeasure);
        break;
    case IFCROTATIONALSTIFFNESSMEASURE :
        setIfcRotationalStiffnessMeasure(obj.m_union.m_IfcRotationalStiffnessMeasure);
        break;
    case IFCSHEARMODULUSMEASURE :
        setIfcShearModulusMeasure(obj.m_union.m_IfcShearModulusMeasure);
        break;
    case IFCLINEARMOMENTMEASURE :
        setIfcLinearMomentMeasure(obj.m_union.m_IfcLinearMomentMeasure);
        break;
    case IFCLUMINOUSINTENSITYDISTRIBUTIONMEASURE :
        setIfcLuminousIntensityDistributionMeasure(obj.m_union.m_IfcLuminousIntensityDistributionMeasure);
        break;
    case IFCCURVATUREMEASURE :
        setIfcCurvatureMeasure(obj.m_union.m_IfcCurvatureMeasure);
        break;
    case IFCMASSPERLENGTHMEASURE :
        setIfcMassPerLengthMeasure(obj.m_union.m_IfcMassPerLengthMeasure);
        break;
    case IFCMODULUSOFLINEARSUBGRADEREACTIONMEASURE :
        setIfcModulusOfLinearSubgradeReactionMeasure(obj.m_union.m_IfcModulusOfLinearSubgradeReactionMeasure);
        break;
    case IFCMODULUSOFROTATIONALSUBGRADEREACTIONMEASURE :
        setIfcModulusOfRotationalSubgradeReactionMeasure(obj.m_union.m_IfcModulusOfRotationalSubgradeReactionMeasure);
        break;
    case IFCROTATIONALMASSMEASURE :
        setIfcRotationalMassMeasure(obj.m_union.m_IfcRotationalMassMeasure);
        break;
    case IFCSECTIONALAREAINTEGRALMEASURE :
        setIfcSectionalAreaIntegralMeasure(obj.m_union.m_IfcSectionalAreaIntegralMeasure);
        break;
    case IFCSECTIONMODULUSMEASURE :
        setIfcSectionModulusMeasure(obj.m_union.m_IfcSectionModulusMeasure);
        break;
    case IFCTEMPERATUREGRADIENTMEASURE :
        setIfcTemperatureGradientMeasure(obj.m_union.m_IfcTemperatureGradientMeasure);
        break;
    case IFCTHERMALEXPANSIONCOEFFICIENTMEASURE :
        setIfcThermalExpansionCoefficientMeasure(obj.m_union.m_IfcThermalExpansionCoefficientMeasure);
        break;
    case IFCWARPINGCONSTANTMEASURE :
        setIfcWarpingConstantMeasure(obj.m_union.m_IfcWarpingConstantMeasure);
        break;
    case IFCWARPINGMOMENTMEASURE :
        setIfcWarpingMomentMeasure(obj.m_union.m_IfcWarpingMomentMeasure);
        break;
    case IFCSOUNDPOWERMEASURE :
        setIfcSoundPowerMeasure(obj.m_union.m_IfcSoundPowerMeasure);
        break;
    case IFCSOUNDPRESSUREMEASURE :
        setIfcSoundPressureMeasure(obj.m_union.m_IfcSoundPressureMeasure);
        break;
    case IFCHEATINGVALUEMEASURE :
        setIfcHeatingValueMeasure(obj.m_union.m_IfcHeatingValueMeasure);
        break;
    case IFCPHMEASURE :
        setIfcPHMeasure(obj.m_union.m_IfcPHMeasure);
        break;
    case IFCIONCONCENTRATIONMEASURE :
        setIfcIonConcentrationMeasure(obj.m_union.m_IfcIonConcentrationMeasure);
        break;
    default:
        break;
    }
...
{ 
    ...
    {
    case IFCDESCRIPTIVEMEASURE :
        delete m_union.m_IfcDescriptiveMeasure;
        break;
    case IFCCOMPLEXNUMBER :
        delete m_union.m_IfcComplexNumber;
        break;
    case IFCIDENTIFIER :
    ...
    case IFCLABEL :
        ...
        break;
    case IFCCOMPOUNDPLANEANGLEMEASURE :
        delete m_union.m_IfcCompoundPlaneAngleMeasure;
        break;
    default:
        break;
    }
...
IfcVolumeMeasure IfcValue::getIfcVolumeMeasure() const
{
    ...
    {
        return m_union.m_IfcVolumeMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcVolumeMeasure);
    }    
}

void IfcValue::setIfcVolumeMeasure(IfcVolumeMeasure value)
{
    m_union.m_IfcVolumeMeasure = value;
...
IfcTimeMeasure IfcValue::getIfcTimeMeasure() const
{
    ...
    {
        return m_union.m_IfcTimeMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcTimeMeasure);
    }    
}

void IfcValue::setIfcTimeMeasure(IfcTimeMeasure value)
{
    m_union.m_IfcTimeMeasure = value;
...
IfcThermodynamicTemperatureMeasure IfcValue::getIfcThermodynamicTemperatureMeasure() const
{
    ...
    {
        return m_union.m_IfcThermodynamicTemperatureMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcThermodynamicTemperatureMeasure);
    }    
}

void IfcValue::setIfcThermodynamicTemperatureMeasure(IfcThermodynamicTemperatureMeasure value)
{
    m_union.m_IfcThermodynamicTemperatureMeasure = value;
...
IfcSolidAngleMeasure IfcValue::getIfcSolidAngleMeasure() const
{
    ...
    {
        return m_union.m_IfcSolidAngleMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcSolidAngleMeasure);
    }    
}

void IfcValue::setIfcSolidAngleMeasure(IfcSolidAngleMeasure value)
{
    m_union.m_IfcSolidAngleMeasure = value;
...
IfcPositiveRatioMeasure IfcValue::getIfcPositiveRatioMeasure() const
{
    ...
    {
        return m_union.m_IfcPositiveRatioMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcPositiveRatioMeasure);
    }    
}

void IfcValue::setIfcPositiveRatioMeasure(IfcPositiveRatioMeasure value)
{
    m_union.m_IfcPositiveRatioMeasure = value;
...
IfcRatioMeasure IfcValue::getIfcRatioMeasure() const
{
    ...
    {
        return m_union.m_IfcRatioMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcRatioMeasure);
    }    
}

void IfcValue::setIfcRatioMeasure(IfcRatioMeasure value)
{
    m_union.m_IfcRatioMeasure = value;
...
IfcPositivePlaneAngleMeasure IfcValue::getIfcPositivePlaneAngleMeasure() const
{
    ...
    {
        return m_union.m_IfcPositivePlaneAngleMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcPositivePlaneAngleMeasure);
    }    
}

void IfcValue::setIfcPositivePlaneAngleMeasure(IfcPositivePlaneAngleMeasure value)
{
    m_union.m_IfcPositivePlaneAngleMeasure = value;
...
IfcNumericMeasure IfcValue::getIfcNumericMeasure() const
{
    ...
    {
        return m_union.m_IfcNumericMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcNumericMeasure);
    }    
}

void IfcValue::setIfcNumericMeasure(IfcNumericMeasure value)
{
    m_union.m_IfcNumericMeasure = value;
...
IfcMassMeasure IfcValue::getIfcMassMeasure() const
{
    ...
    {
        return m_union.m_IfcMassMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcMassMeasure);
    }    
}

void IfcValue::setIfcMassMeasure(IfcMassMeasure value)
{
    m_union.m_IfcMassMeasure = value;
...
IfcLengthMeasure IfcValue::getIfcLengthMeasure() const
{
    ...
    {
        return m_union.m_IfcLengthMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcLengthMeasure);
    }    
}

void IfcValue::setIfcLengthMeasure(IfcLengthMeasure value)
{
    m_union.m_IfcLengthMeasure = value;
...
IfcElectricCurrentMeasure IfcValue::getIfcElectricCurrentMeasure() const
{
    ...
    {
        return m_union.m_IfcElectricCurrentMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcElectricCurrentMeasure);
    }    
}

void IfcValue::setIfcElectricCurrentMeasure(IfcElectricCurrentMeasure value)
{
    m_union.m_IfcElectricCurrentMeasure = value;
...
IfcDescriptiveMeasure IfcValue::getIfcDescriptiveMeasure() const
{
    ...
    {
        return *m_union.m_IfcDescriptiveMeasure;
    }
    else 
    {
        return Step::getUnset(*m_union.m_IfcDescriptiveMeasure);
    }    
}

void IfcValue::setIfcDescriptiveMeasure(const IfcDescriptiveMeasure &value)
{
    m_union.m_IfcDescriptiveMeasure = new IfcDescriptiveMeasure(value);
...
IfcCountMeasure IfcValue::getIfcCountMeasure() const
{
    ...
    {
        return m_union.m_IfcCountMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcCountMeasure);
    }    
}

void IfcValue::setIfcCountMeasure(IfcCountMeasure value)
{
    m_union.m_IfcCountMeasure = value;
...
IfcContextDependentMeasure IfcValue::getIfcContextDependentMeasure() const
{
    ...
    {
        return m_union.m_IfcContextDependentMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcContextDependentMeasure);
    }    
}

void IfcValue::setIfcContextDependentMeasure(IfcContextDependentMeasure value)
{
    m_union.m_IfcContextDependentMeasure = value;
...
IfcAreaMeasure IfcValue::getIfcAreaMeasure() const
{
    ...
    {
        return m_union.m_IfcAreaMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcAreaMeasure);
    }    
}

void IfcValue::setIfcAreaMeasure(IfcAreaMeasure value)
{
    m_union.m_IfcAreaMeasure = value;
...
IfcAmountOfSubstanceMeasure IfcValue::getIfcAmountOfSubstanceMeasure() const
{
    ...
    {
        return m_union.m_IfcAmountOfSubstanceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcAmountOfSubstanceMeasure);
    }    
}

void IfcValue::setIfcAmountOfSubstanceMeasure(IfcAmountOfSubstanceMeasure value)
{
    m_union.m_IfcAmountOfSubstanceMeasure = value;
...
IfcLuminousIntensityMeasure IfcValue::getIfcLuminousIntensityMeasure() const
{
    ...
    {
        return m_union.m_IfcLuminousIntensityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcLuminousIntensityMeasure);
    }    
}

void IfcValue::setIfcLuminousIntensityMeasure(IfcLuminousIntensityMeasure value)
{
    m_union.m_IfcLuminousIntensityMeasure = value;
...
IfcComplexNumber &IfcValue::getIfcComplexNumber() const
{
    ...
    {
        return *m_union.m_IfcComplexNumber;
    }
    else 
    {
        return Step::getUnset(*m_union.m_IfcComplexNumber);
    }    
}

void IfcValue::setIfcComplexNumber(const IfcComplexNumber &value)
{
    m_union.m_IfcComplexNumber = new IfcComplexNumber(value);
...
IfcVolumetricFlowRateMeasure IfcValue::getIfcVolumetricFlowRateMeasure() const
{
    ...
    {
        return m_union.m_IfcVolumetricFlowRateMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcVolumetricFlowRateMeasure);
    }    
}

void IfcValue::setIfcVolumetricFlowRateMeasure(IfcVolumetricFlowRateMeasure value)
{
    m_union.m_IfcVolumetricFlowRateMeasure = value;
...
IfcTimeStamp IfcValue::getIfcTimeStamp() const
{
    ...
    {
        return m_union.m_IfcTimeStamp;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcTimeStamp);
    }    
}

void IfcValue::setIfcTimeStamp(IfcTimeStamp value)
{
    m_union.m_IfcTimeStamp = value;
    m_type = IFCTIMESTAMP ;
}
...
IfcThermalTransmittanceMeasure IfcValue::getIfcThermalTransmittanceMeasure() const
{
    ...
    {
        return m_union.m_IfcThermalTransmittanceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcThermalTransmittanceMeasure);
    }    
}

void IfcValue::setIfcThermalTransmittanceMeasure(IfcThermalTransmittanceMeasure value)
{
    m_union.m_IfcThermalTransmittanceMeasure = value;
...
IfcThermalResistanceMeasure IfcValue::getIfcThermalResistanceMeasure() const
{
    ...
    {
        return m_union.m_IfcThermalResistanceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcThermalResistanceMeasure);
    }    
}

void IfcValue::setIfcThermalResistanceMeasure(IfcThermalResistanceMeasure value)
{
    m_union.m_IfcThermalResistanceMeasure = value;
...
IfcThermalAdmittanceMeasure IfcValue::getIfcThermalAdmittanceMeasure() const
{
    ...
    {
        return m_union.m_IfcThermalAdmittanceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcThermalAdmittanceMeasure);
    }    
}

void IfcValue::setIfcThermalAdmittanceMeasure(IfcThermalAdmittanceMeasure value)
{
    m_union.m_IfcThermalAdmittanceMeasure = value;
...
IfcPressureMeasure IfcValue::getIfcPressureMeasure() const
{
    ...
    {
        return m_union.m_IfcPressureMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcPressureMeasure);
    }    
}

void IfcValue::setIfcPressureMeasure(IfcPressureMeasure value)
{
    m_union.m_IfcPressureMeasure = value;
...
IfcPowerMeasure IfcValue::getIfcPowerMeasure() const
{
    ...
    {
        return m_union.m_IfcPowerMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcPowerMeasure);
    }    
}

void IfcValue::setIfcPowerMeasure(IfcPowerMeasure value)
{
    m_union.m_IfcPowerMeasure = value;
...
IfcMassFlowRateMeasure IfcValue::getIfcMassFlowRateMeasure() const
{
    ...
    {
        return m_union.m_IfcMassFlowRateMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcMassFlowRateMeasure);
    }    
}

void IfcValue::setIfcMassFlowRateMeasure(IfcMassFlowRateMeasure value)
{
    m_union.m_IfcMassFlowRateMeasure = value;
...
IfcMassDensityMeasure IfcValue::getIfcMassDensityMeasure() const
{
    ...
    {
        return m_union.m_IfcMassDensityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcMassDensityMeasure);
    }    
}

void IfcValue::setIfcMassDensityMeasure(IfcMassDensityMeasure value)
{
    m_union.m_IfcMassDensityMeasure = value;
...
IfcLinearVelocityMeasure IfcValue::getIfcLinearVelocityMeasure() const
{
    ...
    {
        return m_union.m_IfcLinearVelocityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcLinearVelocityMeasure);
    }    
}

void IfcValue::setIfcLinearVelocityMeasure(IfcLinearVelocityMeasure value)
{
    m_union.m_IfcLinearVelocityMeasure = value;
...
IfcKinematicViscosityMeasure IfcValue::getIfcKinematicViscosityMeasure() const
{
    ...
    {
        return m_union.m_IfcKinematicViscosityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcKinematicViscosityMeasure);
    }    
}

void IfcValue::setIfcKinematicViscosityMeasure(IfcKinematicViscosityMeasure value)
{
    m_union.m_IfcKinematicViscosityMeasure = value;
...
IfcIntegerCountRateMeasure IfcValue::getIfcIntegerCountRateMeasure() const
{
    ...
    {
        return m_union.m_IfcIntegerCountRateMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcIntegerCountRateMeasure);
    }    
}

void IfcValue::setIfcIntegerCountRateMeasure(IfcIntegerCountRateMeasure value)
{
    m_union.m_IfcIntegerCountRateMeasure = value;
...
IfcHeatFluxDensityMeasure IfcValue::getIfcHeatFluxDensityMeasure() const
{
    ...
    {
        return m_union.m_IfcHeatFluxDensityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcHeatFluxDensityMeasure);
    }    
}

void IfcValue::setIfcHeatFluxDensityMeasure(IfcHeatFluxDensityMeasure value)
{
    m_union.m_IfcHeatFluxDensityMeasure = value;
...
IfcFrequencyMeasure IfcValue::getIfcFrequencyMeasure() const
{
    ...
    {
        return m_union.m_IfcFrequencyMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcFrequencyMeasure);
    }    
}

void IfcValue::setIfcFrequencyMeasure(IfcFrequencyMeasure value)
{
    m_union.m_IfcFrequencyMeasure = value;
...
IfcEnergyMeasure IfcValue::getIfcEnergyMeasure() const
{
    ...
    {
        return m_union.m_IfcEnergyMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcEnergyMeasure);
    }    
}

void IfcValue::setIfcEnergyMeasure(IfcEnergyMeasure value)
{
    m_union.m_IfcEnergyMeasure = value;
...
IfcElectricVoltageMeasure IfcValue::getIfcElectricVoltageMeasure() const
{
    ...
    {
        return m_union.m_IfcElectricVoltageMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcElectricVoltageMeasure);
    }    
}

void IfcValue::setIfcElectricVoltageMeasure(IfcElectricVoltageMeasure value)
{
    m_union.m_IfcElectricVoltageMeasure = value;
...
IfcDynamicViscosityMeasure IfcValue::getIfcDynamicViscosityMeasure() const
{
    ...
    {
        return m_union.m_IfcDynamicViscosityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcDynamicViscosityMeasure);
    }    
}

void IfcValue::setIfcDynamicViscosityMeasure(IfcDynamicViscosityMeasure value)
{
    m_union.m_IfcDynamicViscosityMeasure = value;
...
IfcCompoundPlaneAngleMeasure &IfcValue::getIfcCompoundPlaneAngleMeasure() const
{
    ...
    {
        return *m_union.m_IfcCompoundPlaneAngleMeasure;
    }
    else 
    {
        return Step::getUnset(*m_union.m_IfcCompoundPlaneAngleMeasure);
    }    
}

void IfcValue::setIfcCompoundPlaneAngleMeasure(const IfcCompoundPlaneAngleMeasure &value)
{
    m_union.m_IfcCompoundPlaneAngleMeasure = new IfcCompoundPlaneAngleMeasure(value);
...
IfcAngularVelocityMeasure IfcValue::getIfcAngularVelocityMeasure() const
{
    ...
    {
        return m_union.m_IfcAngularVelocityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcAngularVelocityMeasure);
    }    
}

void IfcValue::setIfcAngularVelocityMeasure(IfcAngularVelocityMeasure value)
{
    m_union.m_IfcAngularVelocityMeasure = value;
...
IfcThermalConductivityMeasure IfcValue::getIfcThermalConductivityMeasure() const
{
    ...
    {
        return m_union.m_IfcThermalConductivityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcThermalConductivityMeasure);
    }    
}

void IfcValue::setIfcThermalConductivityMeasure(IfcThermalConductivityMeasure value)
{
    m_union.m_IfcThermalConductivityMeasure = value;
...
IfcMolecularWeightMeasure IfcValue::getIfcMolecularWeightMeasure() const
{
    ...
    {
        return m_union.m_IfcMolecularWeightMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcMolecularWeightMeasure);
    }    
}

void IfcValue::setIfcMolecularWeightMeasure(IfcMolecularWeightMeasure value)
{
    m_union.m_IfcMolecularWeightMeasure = value;
...
IfcVaporPermeabilityMeasure IfcValue::getIfcVaporPermeabilityMeasure() const
{
    ...
    {
        return m_union.m_IfcVaporPermeabilityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcVaporPermeabilityMeasure);
    }    
}

void IfcValue::setIfcVaporPermeabilityMeasure(IfcVaporPermeabilityMeasure value)
{
    m_union.m_IfcVaporPermeabilityMeasure = value;
...
IfcMoistureDiffusivityMeasure IfcValue::getIfcMoistureDiffusivityMeasure() const
{
    ...
    {
        return m_union.m_IfcMoistureDiffusivityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcMoistureDiffusivityMeasure);
    }    
}

void IfcValue::setIfcMoistureDiffusivityMeasure(IfcMoistureDiffusivityMeasure value)
{
    m_union.m_IfcMoistureDiffusivityMeasure = value;
...
IfcIsothermalMoistureCapacityMeasure IfcValue::getIfcIsothermalMoistureCapacityMeasure() const
{
    ...
    {
        return m_union.m_IfcIsothermalMoistureCapacityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcIsothermalMoistureCapacityMeasure);
    }    
}

void IfcValue::setIfcIsothermalMoistureCapacityMeasure(IfcIsothermalMoistureCapacityMeasure value)
{
    m_union.m_IfcIsothermalMoistureCapacityMeasure = value;
...
IfcSpecificHeatCapacityMeasure IfcValue::getIfcSpecificHeatCapacityMeasure() const
{
    ...
    {
        return m_union.m_IfcSpecificHeatCapacityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcSpecificHeatCapacityMeasure);
    }    
}

void IfcValue::setIfcSpecificHeatCapacityMeasure(IfcSpecificHeatCapacityMeasure value)
{
    m_union.m_IfcSpecificHeatCapacityMeasure = value;
...
IfcMonetaryMeasure IfcValue::getIfcMonetaryMeasure() const
{
    ...
    {
        return m_union.m_IfcMonetaryMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcMonetaryMeasure);
    }    
}

void IfcValue::setIfcMonetaryMeasure(IfcMonetaryMeasure value)
{
    m_union.m_IfcMonetaryMeasure = value;
...
IfcMagneticFluxDensityMeasure IfcValue::getIfcMagneticFluxDensityMeasure() const
{
    ...
    {
        return m_union.m_IfcMagneticFluxDensityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcMagneticFluxDensityMeasure);
    }    
}

void IfcValue::setIfcMagneticFluxDensityMeasure(IfcMagneticFluxDensityMeasure value)
{
    m_union.m_IfcMagneticFluxDensityMeasure = value;
...
IfcMagneticFluxMeasure IfcValue::getIfcMagneticFluxMeasure() const
{
    ...
    {
        return m_union.m_IfcMagneticFluxMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcMagneticFluxMeasure);
    }    
}

void IfcValue::setIfcMagneticFluxMeasure(IfcMagneticFluxMeasure value)
{
    m_union.m_IfcMagneticFluxMeasure = value;
...
IfcLuminousFluxMeasure IfcValue::getIfcLuminousFluxMeasure() const
{
    ...
    {
        return m_union.m_IfcLuminousFluxMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcLuminousFluxMeasure);
    }    
}

void IfcValue::setIfcLuminousFluxMeasure(IfcLuminousFluxMeasure value)
{
    m_union.m_IfcLuminousFluxMeasure = value;
...
IfcForceMeasure IfcValue::getIfcForceMeasure() const
{
    ...
    {
        return m_union.m_IfcForceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcForceMeasure);
    }    
}

void IfcValue::setIfcForceMeasure(IfcForceMeasure value)
{
    m_union.m_IfcForceMeasure = value;
...
IfcInductanceMeasure IfcValue::getIfcInductanceMeasure() const
{
    ...
    {
        return m_union.m_IfcInductanceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcInductanceMeasure);
    }    
}

void IfcValue::setIfcInductanceMeasure(IfcInductanceMeasure value)
{
    m_union.m_IfcInductanceMeasure = value;
...
IfcIlluminanceMeasure IfcValue::getIfcIlluminanceMeasure() const
{
    ...
    {
        return m_union.m_IfcIlluminanceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcIlluminanceMeasure);
    }    
}

void IfcValue::setIfcIlluminanceMeasure(IfcIlluminanceMeasure value)
{
    m_union.m_IfcIlluminanceMeasure = value;
...
IfcElectricResistanceMeasure IfcValue::getIfcElectricResistanceMeasure() const
{
    ...
    {
        return m_union.m_IfcElectricResistanceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcElectricResistanceMeasure);
    }    
}

void IfcValue::setIfcElectricResistanceMeasure(IfcElectricResistanceMeasure value)
{
    m_union.m_IfcElectricResistanceMeasure = value;
...
IfcElectricConductanceMeasure IfcValue::getIfcElectricConductanceMeasure() const
{
    ...
    {
        return m_union.m_IfcElectricConductanceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcElectricConductanceMeasure);
    }    
}

void IfcValue::setIfcElectricConductanceMeasure(IfcElectricConductanceMeasure value)
{
    m_union.m_IfcElectricConductanceMeasure = value;
...
IfcElectricChargeMeasure IfcValue::getIfcElectricChargeMeasure() const
{
    ...
    {
        return m_union.m_IfcElectricChargeMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcElectricChargeMeasure);
    }    
}

void IfcValue::setIfcElectricChargeMeasure(IfcElectricChargeMeasure value)
{
    m_union.m_IfcElectricChargeMeasure = value;
...
IfcDoseEquivalentMeasure IfcValue::getIfcDoseEquivalentMeasure() const
{
    ...
    {
        return m_union.m_IfcDoseEquivalentMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcDoseEquivalentMeasure);
    }    
}

void IfcValue::setIfcDoseEquivalentMeasure(IfcDoseEquivalentMeasure value)
{
    m_union.m_IfcDoseEquivalentMeasure = value;
...
IfcElectricCapacitanceMeasure IfcValue::getIfcElectricCapacitanceMeasure() const
{
    ...
    {
        return m_union.m_IfcElectricCapacitanceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcElectricCapacitanceMeasure);
    }    
}

void IfcValue::setIfcElectricCapacitanceMeasure(IfcElectricCapacitanceMeasure value)
{
    m_union.m_IfcElectricCapacitanceMeasure = value;
...
IfcAbsorbedDoseMeasure IfcValue::getIfcAbsorbedDoseMeasure() const
{
    ...
    {
        return m_union.m_IfcAbsorbedDoseMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcAbsorbedDoseMeasure);
    }    
}

void IfcValue::setIfcAbsorbedDoseMeasure(IfcAbsorbedDoseMeasure value)
{
    m_union.m_IfcAbsorbedDoseMeasure = value;
...
IfcRadioActivityMeasure IfcValue::getIfcRadioActivityMeasure() const
{
    ...
    {
        return m_union.m_IfcRadioActivityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcRadioActivityMeasure);
    }    
}

void IfcValue::setIfcRadioActivityMeasure(IfcRadioActivityMeasure value)
{
    m_union.m_IfcRadioActivityMeasure = value;
...
IfcRotationalFrequencyMeasure IfcValue::getIfcRotationalFrequencyMeasure() const
{
    ...
    {
        return m_union.m_IfcRotationalFrequencyMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcRotationalFrequencyMeasure);
    }    
}

void IfcValue::setIfcRotationalFrequencyMeasure(IfcRotationalFrequencyMeasure value)
{
    m_union.m_IfcRotationalFrequencyMeasure = value;
...
IfcTorqueMeasure IfcValue::getIfcTorqueMeasure() const
{
    ...
    {
        return m_union.m_IfcTorqueMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcTorqueMeasure);
    }    
}

void IfcValue::setIfcTorqueMeasure(IfcTorqueMeasure value)
{
    m_union.m_IfcTorqueMeasure = value;
...
IfcAccelerationMeasure IfcValue::getIfcAccelerationMeasure() const
{
    ...
    {
        return m_union.m_IfcAccelerationMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcAccelerationMeasure);
    }    
}

void IfcValue::setIfcAccelerationMeasure(IfcAccelerationMeasure value)
{
    m_union.m_IfcAccelerationMeasure = value;
...
IfcLinearForceMeasure IfcValue::getIfcLinearForceMeasure() const
{
    ...
    {
        return m_union.m_IfcLinearForceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcLinearForceMeasure);
    }    
}

void IfcValue::setIfcLinearForceMeasure(IfcLinearForceMeasure value)
{
    m_union.m_IfcLinearForceMeasure = value;
...
IfcLinearStiffnessMeasure IfcValue::getIfcLinearStiffnessMeasure() const
{
    ...
    {
        return m_union.m_IfcLinearStiffnessMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcLinearStiffnessMeasure);
    }    
}

void IfcValue::setIfcLinearStiffnessMeasure(IfcLinearStiffnessMeasure value)
{
    m_union.m_IfcLinearStiffnessMeasure = value;
...
IfcModulusOfSubgradeReactionMeasure IfcValue::getIfcModulusOfSubgradeReactionMeasure() const
{
    ...
    {
        return m_union.m_IfcModulusOfSubgradeReactionMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcModulusOfSubgradeReactionMeasure);
    }    
}

void IfcValue::setIfcModulusOfSubgradeReactionMeasure(IfcModulusOfSubgradeReactionMeasure value)
{
    m_union.m_IfcModulusOfSubgradeReactionMeasure = value;
...
IfcModulusOfElasticityMeasure IfcValue::getIfcModulusOfElasticityMeasure() const
{
    ...
    {
        return m_union.m_IfcModulusOfElasticityMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcModulusOfElasticityMeasure);
    }    
}

void IfcValue::setIfcModulusOfElasticityMeasure(IfcModulusOfElasticityMeasure value)
{
    m_union.m_IfcModulusOfElasticityMeasure = value;
...
IfcMomentOfInertiaMeasure IfcValue::getIfcMomentOfInertiaMeasure() const
{
    ...
    {
        return m_union.m_IfcMomentOfInertiaMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcMomentOfInertiaMeasure);
    }    
}

void IfcValue::setIfcMomentOfInertiaMeasure(IfcMomentOfInertiaMeasure value)
{
    m_union.m_IfcMomentOfInertiaMeasure = value;
...
IfcPlanarForceMeasure IfcValue::getIfcPlanarForceMeasure() const
{
    ...
    {
        return m_union.m_IfcPlanarForceMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcPlanarForceMeasure);
    }    
}

void IfcValue::setIfcPlanarForceMeasure(IfcPlanarForceMeasure value)
{
    m_union.m_IfcPlanarForceMeasure = value;
...
IfcRotationalStiffnessMeasure IfcValue::getIfcRotationalStiffnessMeasure() const
{
    ...
    {
        return m_union.m_IfcRotationalStiffnessMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcRotationalStiffnessMeasure);
    }    
}

void IfcValue::setIfcRotationalStiffnessMeasure(IfcRotationalStiffnessMeasure value)
{
    m_union.m_IfcRotationalStiffnessMeasure = value;
...
IfcShearModulusMeasure IfcValue::getIfcShearModulusMeasure() const
{
    ...
    {
        return m_union.m_IfcShearModulusMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcShearModulusMeasure);
    }    
}

void IfcValue::setIfcShearModulusMeasure(IfcShearModulusMeasure value)
{
    m_union.m_IfcShearModulusMeasure = value;
...
IfcLinearMomentMeasure IfcValue::getIfcLinearMomentMeasure() const
{
    ...
    {
        return m_union.m_IfcLinearMomentMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcLinearMomentMeasure);
    }    
}

void IfcValue::setIfcLinearMomentMeasure(IfcLinearMomentMeasure value)
{
    m_union.m_IfcLinearMomentMeasure = value;
...
IfcLuminousIntensityDistributionMeasure IfcValue::getIfcLuminousIntensityDistributionMeasure() const
{
    ...
    {
        return m_union.m_IfcLuminousIntensityDistributionMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcLuminousIntensityDistributionMeasure);
    }    
}

void IfcValue::setIfcLuminousIntensityDistributionMeasure(IfcLuminousIntensityDistributionMeasure value)
{
    m_union.m_IfcLuminousIntensityDistributionMeasure = value;
...
IfcCurvatureMeasure IfcValue::getIfcCurvatureMeasure() const
{
    ...
    {
        return m_union.m_IfcCurvatureMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcCurvatureMeasure);
    }    
}

void IfcValue::setIfcCurvatureMeasure(IfcCurvatureMeasure value)
{
    m_union.m_IfcCurvatureMeasure = value;
...
IfcMassPerLengthMeasure IfcValue::getIfcMassPerLengthMeasure() const
{
    ...
    {
        return m_union.m_IfcMassPerLengthMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcMassPerLengthMeasure);
    }    
}

void IfcValue::setIfcMassPerLengthMeasure(IfcMassPerLengthMeasure value)
{
    m_union.m_IfcMassPerLengthMeasure = value;
...
IfcModulusOfLinearSubgradeReactionMeasure IfcValue::getIfcModulusOfLinearSubgradeReactionMeasure() const
{
    ...
    {
        return m_union.m_IfcModulusOfLinearSubgradeReactionMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcModulusOfLinearSubgradeReactionMeasure);
    }    
}

void IfcValue::setIfcModulusOfLinearSubgradeReactionMeasure(IfcModulusOfLinearSubgradeReactionMeasure value)
{
    m_union.m_IfcModulusOfLinearSubgradeReactionMeasure = value;
...
IfcModulusOfRotationalSubgradeReactionMeasure IfcValue::getIfcModulusOfRotationalSubgradeReactionMeasure() const
{
    ...
    {
        return m_union.m_IfcModulusOfRotationalSubgradeReactionMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcModulusOfRotationalSubgradeReactionMeasure);
    }    
}

void IfcValue::setIfcModulusOfRotationalSubgradeReactionMeasure(IfcModulusOfRotationalSubgradeReactionMeasure value)
{
    m_union.m_IfcModulusOfRotationalSubgradeReactionMeasure = value;
...
IfcRotationalMassMeasure IfcValue::getIfcRotationalMassMeasure() const
{
    ...
    {
        return m_union.m_IfcRotationalMassMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcRotationalMassMeasure);
    }    
}

void IfcValue::setIfcRotationalMassMeasure(IfcRotationalMassMeasure value)
{
    m_union.m_IfcRotationalMassMeasure = value;
...
IfcSectionalAreaIntegralMeasure IfcValue::getIfcSectionalAreaIntegralMeasure() const
{
    ...
    {
        return m_union.m_IfcSectionalAreaIntegralMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcSectionalAreaIntegralMeasure);
    }    
}

void IfcValue::setIfcSectionalAreaIntegralMeasure(IfcSectionalAreaIntegralMeasure value)
{
    m_union.m_IfcSectionalAreaIntegralMeasure = value;
...
IfcSectionModulusMeasure IfcValue::getIfcSectionModulusMeasure() const
{
    ...
    {
        return m_union.m_IfcSectionModulusMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcSectionModulusMeasure);
    }    
}

void IfcValue::setIfcSectionModulusMeasure(IfcSectionModulusMeasure value)
{
    m_union.m_IfcSectionModulusMeasure = value;
...
IfcTemperatureGradientMeasure IfcValue::getIfcTemperatureGradientMeasure() const
{
    ...
    {
        return m_union.m_IfcTemperatureGradientMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcTemperatureGradientMeasure);
    }    
}

void IfcValue::setIfcTemperatureGradientMeasure(IfcTemperatureGradientMeasure value)
{
    m_union.m_IfcTemperatureGradientMeasure = value;
...
IfcThermalExpansionCoefficientMeasure IfcValue::getIfcThermalExpansionCoefficientMeasure() const
{
    ...
    {
        return m_union.m_IfcThermalExpansionCoefficientMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcThermalExpansionCoefficientMeasure);
    }    
}

void IfcValue::setIfcThermalExpansionCoefficientMeasure(IfcThermalExpansionCoefficientMeasure value)
{
    m_union.m_IfcThermalExpansionCoefficientMeasure = value;
...
IfcWarpingConstantMeasure IfcValue::getIfcWarpingConstantMeasure() const
{
    ...
    {
        return m_union.m_IfcWarpingConstantMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcWarpingConstantMeasure);
    }    
}

void IfcValue::setIfcWarpingConstantMeasure(IfcWarpingConstantMeasure value)
{
    m_union.m_IfcWarpingConstantMeasure = value;
...
IfcWarpingMomentMeasure IfcValue::getIfcWarpingMomentMeasure() const
{
    ...
    {
        return m_union.m_IfcWarpingMomentMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcWarpingMomentMeasure);
    }    
}

void IfcValue::setIfcWarpingMomentMeasure(IfcWarpingMomentMeasure value)
{
    m_union.m_IfcWarpingMomentMeasure = value;
...
IfcSoundPowerMeasure IfcValue::getIfcSoundPowerMeasure() const
{
    ...
    {
        return m_union.m_IfcSoundPowerMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcSoundPowerMeasure);
    }    
}

void IfcValue::setIfcSoundPowerMeasure(IfcSoundPowerMeasure value)
{
    m_union.m_IfcSoundPowerMeasure = value;
...
IfcSoundPressureMeasure IfcValue::getIfcSoundPressureMeasure() const
{
    ...
    {
        return m_union.m_IfcSoundPressureMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcSoundPressureMeasure);
    }    
}

void IfcValue::setIfcSoundPressureMeasure(IfcSoundPressureMeasure value)
{
    m_union.m_IfcSoundPressureMeasure = value;
...
IfcHeatingValueMeasure IfcValue::getIfcHeatingValueMeasure() const
{
    ...
    {
        return m_union.m_IfcHeatingValueMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcHeatingValueMeasure);
    }    
}

void IfcValue::setIfcHeatingValueMeasure(IfcHeatingValueMeasure value)
{
    m_union.m_IfcHeatingValueMeasure = value;
...
IfcPHMeasure IfcValue::getIfcPHMeasure() const
{
    ...
    {
        return m_union.m_IfcPHMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcPHMeasure);
    }    
}

void IfcValue::setIfcPHMeasure(IfcPHMeasure value)
{
    m_union.m_IfcPHMeasure = value;
    m_type = IFCPHMEASURE ;
}
...
IfcIonConcentrationMeasure IfcValue::getIfcIonConcentrationMeasure() const
{
    ...
    {
        return m_union.m_IfcIonConcentrationMeasure;
    }
    else 
    {
        return Step::getUnset(m_union.m_IfcIonConcentrationMeasure);
    }    
}

void IfcValue::setIfcIonConcentrationMeasure(IfcIonConcentrationMeasure value)
{
    m_union.m_IfcIonConcentrationMeasure = value;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcValue, Step::BaseObject)
