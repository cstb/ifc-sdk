...
IfcProjectionElement::IfcProjectionElement(Step::Id id, Step::SPFData *args) : 
    IfcFeatureElementAddition(id, args)
{
}
...
{
    if (IfcFeatureElementAddition::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcProjectionElement, IfcFeatureElementAddition)
