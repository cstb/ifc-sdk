...
IfcPropertyEnumeratedValue::IfcPropertyEnumeratedValue(Step::SPFData *args) : IfcSimpleProperty(args) {
...
bool IfcPropertyEnumeratedValue::acceptVisitor(Step::BaseVisitor *v) {
  return static_cast< Visitor * > (v)->visitIfcPropertyEnumeratedValue(this);
}

const char *IfcPropertyEnumeratedValue::type() {
  return "IfcPropertyEnumeratedValue";
}

Step::ClassType IfcPropertyEnumeratedValue::getClassType() {
  return IfcPropertyEnumeratedValue::s_type;
}

Step::ClassType IfcPropertyEnumeratedValue::getType() const {
  return IfcPropertyEnumeratedValue::s_type;
}

bool IfcPropertyEnumeratedValue::isOfType(Step::ClassType t) {
  return IfcPropertyEnumeratedValue::s_type == t ? true : IfcSimpleProperty::isOfType(t);
}

Step::StepList< Step::RefPtr< IfcValue > > &IfcPropertyEnumeratedValue::getEnumerationValues() {
...
void IfcPropertyEnumeratedValue::setEnumerationValues(const Step::StepList< Step::RefPtr< IfcValue > > &value) {
...
void IfcPropertyEnumeratedValue::release() {
  IfcSimpleProperty::release();
  m_enumerationValues.clear();
  m_enumerationReference.release();
}
...
bool IfcPropertyEnumeratedValue::init() {
  ...
  if (arg == "$" || arg == "*") {
    ...
    m_enumerationReference = static_cast< IfcPropertyEnumeration * > (m_model->getObjectById(atoi(arg.c_str() + 1)));
  }
  return true;
}

IFC2X3_DLL_DEF Step::ClassType IfcPropertyEnumeratedValue::s_type = new Step::ClassType_class("IfcPropertyEnumeratedValue");
IfcPropertyEnumeratedValue_Factory::IfcPropertyEnumeratedValue_Factory() {
}
...
void IfcPropertyEnumeratedValue_Factory::clear(bool b) {
}

std::map<Step::StepId,Step::BaseObject*>::iterator IfcPropertyEnumeratedValue_Factory::begin() {
  return m_idMap.begin();
}

std::map<Step::StepId,Step::BaseObject*>::iterator IfcPropertyEnumeratedValue_Factory::end() {
  return m_idMap.end();
}

IfcPropertyEnumeratedValue *IfcPropertyEnumeratedValue_Factory::get(Step::StepId id) {
  IfcPropertyEnumeratedValue *value;
  std::map<Step::StepId,Step::BaseObject*>::iterator it = m_idMap.find(id);
  if (it != m_idMap.end()) {
    value = static_cast< IfcPropertyEnumeratedValue * > (it->second);
  }
  else {
    LOG_ERROR("IfcPropertyEnumeratedValue_Factory::get() : Key not found.");
    return NULL;
  }
  if (value) {
    return value;
    ...
    return static_cast< IfcPropertyEnumeratedValue * > (create(id));
  }
}

Step::BaseObject *IfcPropertyEnumeratedValue_Factory::create(Step::StepId id) {
  IfcPropertyEnumeratedValue *ret = new IfcPropertyEnumeratedValue(m_model->getArgs(id));
  ret->set_key(id);
...
Step::BaseObject *IfcPropertyEnumeratedValue_Factory::create(STEP_MAP<Step::StepId, Step::BaseObjectPtr >::iterator it) {
  IfcPropertyEnumeratedValue *ret = new IfcPropertyEnumeratedValue(it->second->getArgs());
...
Step::BaseObject *IfcPropertyEnumeratedValue_Factory::create(std::map<Step::StepId, Step::BaseObject*>::iterator it) {
  IfcPropertyEnumeratedValue *ret = new IfcPropertyEnumeratedValue(m_model->getArgs(it->first));
  ret->set_key(it->first);
  m_model->registerObject(it->first, ret);
  it->second = ret;
  return ret;
...
IfcPropertyEnumeratedValue *IfcPropertyEnumeratedValue_Factory::generate() {
  return static_cast< IfcPropertyEnumeratedValue * > (create(m_model->getNewId()));
}

IfcPropertyEnumeratedValue *IfcPropertyEnumeratedValue_Factory::find(Step::StepId id) {
  std::map<Step::StepId,Step::BaseObject*>::iterator it = m_idMap.find(id);
  if (it != m_idMap.end()) {
    return static_cast< IfcPropertyEnumeratedValue * > (it->second);
  }
  else {
    return NULL;
  }
