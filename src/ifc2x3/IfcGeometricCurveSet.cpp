...
IfcGeometricCurveSet::IfcGeometricCurveSet(Step::Id id, Step::SPFData *args) : 
    IfcGeometricSet(id, args)
{
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcGeometricCurveSet, IfcGeometricSet)
