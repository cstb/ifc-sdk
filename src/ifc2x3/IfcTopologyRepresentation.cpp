...
bool IfcTopologyRepresentation::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcTopologyRepresentation::s_type("IfcTopologyRepresentation","IfcShapeModel");
