...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcActorRole (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcAddress (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcApplication (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcAppliedValue(IfcAppliedValue * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcAppliedValue (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcAppliedValueRelationship(IfcAppliedValueRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcAppliedValueRelationship (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcApproval(IfcApproval * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcApproval (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcApprovalActorRelationship(IfcApprovalActorRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcApprovalActorRelationship (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcApprovalPropertyRelationship(IfcApprovalPropertyRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcApprovalPropertyRelationship (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcApprovalRelationship(IfcApprovalRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcApprovalRelationship (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcBoundaryCondition (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCalendarDate (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcClassification (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcClassificationItem(IfcClassificationItem * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcClassificationItem (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcClassificationItemRelationship(IfcClassificationItemRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcClassificationItemRelationship (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcClassificationNotation(IfcClassificationNotation * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcClassificationNotation (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcClassificationNotationFacet(IfcClassificationNotationFacet * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcClassificationNotationFacet (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcColourSpecification (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcConnectionGeometry (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcConstraint (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcConstraintAggregationRelationship(IfcConstraintAggregationRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcConstraintAggregationRelationship (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcConstraintClassificationRelationship(IfcConstraintClassificationRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcConstraintClassificationRelationship (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcConstraintRelationship(IfcConstraintRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcConstraintRelationship (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCoordinatedUniversalTimeOffset (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCurrencyRelationship (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCurveStyleFont (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcCurveStyleFontAndScaling(IfcCurveStyleFontAndScaling * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCurveStyleFontAndScaling (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcCurveStyleFontPattern(IfcCurveStyleFontPattern * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCurveStyleFontPattern (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDateAndTime (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDerivedUnit (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcDerivedUnitElement(IfcDerivedUnitElement * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDerivedUnitElement (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDimensionalExponents (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDocumentElectronicFormat (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcDocumentInformation(IfcDocumentInformation * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDocumentInformation (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcDocumentInformationRelationship(IfcDocumentInformationRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDocumentInformationRelationship (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDraughtingCalloutRelationship (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcExternalReference (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcGridAxis (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcIrregularTimeSeriesValue (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcLibraryInformation (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcLightDistributionData (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcLightIntensityDistribution (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcLocalTime (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMaterial (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcMaterialClassificationRelationship(IfcMaterialClassificationRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMaterialClassificationRelationship (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMaterialLayer (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcMaterialLayerSet(IfcMaterialLayerSet * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMaterialLayerSet (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcMaterialLayerSetUsage(IfcMaterialLayerSetUsage * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMaterialLayerSetUsage (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcMaterialList(IfcMaterialList * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMaterialList (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcMaterialProperties(IfcMaterialProperties * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMaterialProperties (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcMeasureWithUnit(IfcMeasureWithUnit * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMeasureWithUnit (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMonetaryUnit (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcNamedUnit (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcObjectPlacement (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcOrganization (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcOrganizationRelationship(IfcOrganizationRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcOrganizationRelationship (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcOwnerHistory (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPerson (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcPersonAndOrganization(IfcPersonAndOrganization * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPersonAndOrganization (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPhysicalQuantity (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPreDefinedItem (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPresentationLayerAssignment (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPresentationStyle (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcPresentationStyleAssignment(IfcPresentationStyleAssignment * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPresentationStyleAssignment (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcProductRepresentation (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcProfileDef (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcProfileProperties(IfcProfileProperties * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcProfileProperties (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcProperty (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPropertyConstraintRelationship (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPropertyDependencyRelationship (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPropertyEnumeration (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcReferencesValueDocument (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcReinforcementBarProperties (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcRelaxation (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcRepresentation (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcRepresentationContext(IfcRepresentationContext * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcRepresentationContext (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcRepresentationItem(IfcRepresentationItem * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcRepresentationItem (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcRepresentationMap(IfcRepresentationMap * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcRepresentationMap (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcRoot (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSectionProperties (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcSectionReinforcementProperties(IfcSectionReinforcementProperties * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSectionReinforcementProperties (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcShapeAspect (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcStructuralConnectionCondition (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcStructuralLoad (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSurfaceStyleLighting (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcSurfaceStyleRefraction(IfcSurfaceStyleRefraction * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSurfaceStyleRefraction (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSurfaceStyleShading (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcSurfaceStyleWithTextures(IfcSurfaceStyleWithTextures * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSurfaceStyleWithTextures (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcSurfaceTexture(IfcSurfaceTexture * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSurfaceTexture (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTable (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcTableRow(IfcTableRow * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTableRow (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTextStyleForDefinedFont (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcTextStyleTextModel(IfcTextStyleTextModel * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTextStyleTextModel (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcTextStyleWithBoxCharacteristics(IfcTextStyleWithBoxCharacteristics * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTextStyleWithBoxCharacteristics (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcTextureCoordinate(IfcTextureCoordinate * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTextureCoordinate (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTextureVertex (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTimeSeries (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcTimeSeriesReferenceRelationship(IfcTimeSeriesReferenceRelationship * value)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTimeSeriesReferenceRelationship (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTimeSeriesValue (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcUnitAssignment (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcVertexBasedTextureMap (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcVirtualGridIntersection (was " << value->type() << ")");
    return false;
}
...
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcActorSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcAppliedValueSelect(IfcAppliedValueSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcAppliedValueSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcAxis2Placement(IfcAxis2Placement * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcAxis2Placement (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcBooleanOperand(IfcBooleanOperand * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcBooleanOperand (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcCharacterStyleSelect(IfcCharacterStyleSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCharacterStyleSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcClassificationNotationSelect(IfcClassificationNotationSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcClassificationNotationSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcColour(IfcColour * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcColour (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcColourOrFactor(IfcColourOrFactor * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcColourOrFactor (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcConditionCriterionSelect(IfcConditionCriterionSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcConditionCriterionSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcCsgSelect(IfcCsgSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCsgSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcCurveFontOrScaledCurveFontSelect(IfcCurveFontOrScaledCurveFontSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCurveFontOrScaledCurveFontSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcCurveOrEdgeCurve(IfcCurveOrEdgeCurve * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCurveOrEdgeCurve (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcCurveStyleFontSelect(IfcCurveStyleFontSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcCurveStyleFontSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcDateTimeSelect(IfcDateTimeSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDateTimeSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcDefinedSymbolSelect(IfcDefinedSymbolSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDefinedSymbolSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcDerivedMeasureValue(IfcDerivedMeasureValue * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDerivedMeasureValue (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcDocumentSelect(IfcDocumentSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDocumentSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcDraughtingCalloutElement(IfcDraughtingCalloutElement * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcDraughtingCalloutElement (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcFillAreaStyleTileShapeSelect(IfcFillAreaStyleTileShapeSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcFillAreaStyleTileShapeSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcFillStyleSelect(IfcFillStyleSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcFillStyleSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcGeometricSetSelect(IfcGeometricSetSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcGeometricSetSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcHatchLineDistanceSelect(IfcHatchLineDistanceSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcHatchLineDistanceSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcLayeredItem(IfcLayeredItem * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcLayeredItem (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcLibrarySelect(IfcLibrarySelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcLibrarySelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcLightDistributionDataSourceSelect(IfcLightDistributionDataSourceSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcLightDistributionDataSourceSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcMaterialSelect(IfcMaterialSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMaterialSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcMeasureValue(IfcMeasureValue * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMeasureValue (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcMetricValueSelect(IfcMetricValueSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcMetricValueSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcObjectReferenceSelect(IfcObjectReferenceSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcObjectReferenceSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcOrientationSelect(IfcOrientationSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcOrientationSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcPointOrVertexPoint(IfcPointOrVertexPoint * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPointOrVertexPoint (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcPresentationStyleSelect(IfcPresentationStyleSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcPresentationStyleSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcShell(IfcShell * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcShell (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcSimpleValue(IfcSimpleValue * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSimpleValue (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcSizeSelect(IfcSizeSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSizeSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcSpecularHighlightSelect(IfcSpecularHighlightSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSpecularHighlightSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcStructuralActivityAssignmentSelect(IfcStructuralActivityAssignmentSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcStructuralActivityAssignmentSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcSurfaceOrFaceSurface(IfcSurfaceOrFaceSurface * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSurfaceOrFaceSurface (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcSurfaceStyleElementSelect(IfcSurfaceStyleElementSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSurfaceStyleElementSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcSymbolStyleSelect(IfcSymbolStyleSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcSymbolStyleSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcTextFontSelect(IfcTextFontSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTextFontSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcTextStyleSelect(IfcTextStyleSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTextStyleSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcTrimmingSelect(IfcTrimmingSelect * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcTrimmingSelect (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcUnit(IfcUnit * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcUnit (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcValue(IfcValue * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcValue (was " << value->type() << ")");
    return false;
}

bool InheritVisitor::visitIfcVectorOrDirection(IfcVectorOrDirection * /*value*/)
{
    STEP_LOG_DEBUG(m_logger, "Failed to visit IfcVectorOrDirection (was " << value->type() << ")");
    return false;
}
