...
IfcWallStandardCase::IfcWallStandardCase(Step::Id id, Step::SPFData *args) : 
    IfcWall(id, args)
{
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcWallStandardCase, IfcWall)
