...
bool IfcDiscreteAccessory::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcDiscreteAccessory::s_type("IfcDiscreteAccessory","IfcElementComponent");
