...
bool IfcDistributionElement::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcDistributionElement::s_type("IfcDistributionElement","IfcElement");
