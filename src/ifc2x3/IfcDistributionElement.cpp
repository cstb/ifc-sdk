...
IfcDistributionElement::IfcDistributionElement(Step::Id id, Step::SPFData *args) : 
    IfcElement(id, args)
{
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcDistributionElement, IfcElement)
