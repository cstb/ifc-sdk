...
bool IfcStructuralCurveConnection::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcStructuralCurveConnection::s_type("IfcStructuralCurveConnection","IfcStructuralConnection");
