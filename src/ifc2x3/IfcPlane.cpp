...
IfcPlane::IfcPlane(Step::Id id, Step::SPFData *args) : 
    IfcElementarySurface(id, args)
{
}
...
bool IfcPlane::init()
{
    if (IfcElementarySurface::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcPlane, IfcElementarySurface)
