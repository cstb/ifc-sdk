...
IfcDistributionChamberElement::IfcDistributionChamberElement(Step::Id id, Step::SPFData *args) : 
    IfcDistributionFlowElement(id, args)
{
}
...
{
    if (IfcDistributionFlowElement::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcDistributionChamberElement, IfcDistributionFlowElement)
