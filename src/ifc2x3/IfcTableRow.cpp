...
IfcTableRow::IfcTableRow(Step::Id id, Step::SPFData *args) : 
...
{
    return const_cast<IfcTableRow *>(this)->getRowCells();
}
...
Step::Boolean IfcTableRow::getIsHeading() const
{
    return const_cast<IfcTableRow *>(this)->getIsHeading();
}
...
{
    return  const_cast< IfcTableRow * > (this)->getOfTable();
}
...
void IfcTableRow::copy(const IfcTableRow &obj, const CopyOp &copyop)
{
    ...
    List_IfcValue_1_n::const_iterator it_m_RowCells;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcTableRow, Step::BaseEntity)
