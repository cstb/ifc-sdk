...
bool IfcRelProjectsElement::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcRelProjectsElement::s_type("IfcRelProjectsElement","IfcRelConnects");
