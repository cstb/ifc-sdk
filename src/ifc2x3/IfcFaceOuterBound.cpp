...
IfcFaceOuterBound::IfcFaceOuterBound(Step::Id id, Step::SPFData *args) : 
    IfcFaceBound(id, args)
{
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcFaceOuterBound, IfcFaceBound)
