...
IfcAnnotationOccurrence::IfcAnnotationOccurrence(Step::Id id, Step::SPFData *args) : 
    IfcStyledItem(id, args)
{
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcAnnotationOccurrence, IfcStyledItem)
