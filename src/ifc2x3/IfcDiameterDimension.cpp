...
IfcDiameterDimension::IfcDiameterDimension(Step::Id id, Step::SPFData *args) : 
    IfcDimensionCurveDirectedCallout(id, args)
{
}
...
{
    if (IfcDimensionCurveDirectedCallout::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcDiameterDimension, IfcDimensionCurveDirectedCallout)
