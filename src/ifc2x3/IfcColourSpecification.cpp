...
IfcColourSpecification::IfcColourSpecification(Step::Id id, Step::SPFData *args) : 
...
{
    return const_cast<IfcColourSpecification *>(this)->getName();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcColourSpecification, Step::BaseEntity)
