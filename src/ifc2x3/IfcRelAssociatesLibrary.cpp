...
IfcRelAssociatesLibrary::IfcRelAssociatesLibrary(Step::Id id, Step::SPFData *args) : 
...
{
    return const_cast<IfcRelAssociatesLibrary *>(this)->getRelatingLibrary();
}
...
void IfcRelAssociatesLibrary::copy(const IfcRelAssociatesLibrary &obj, const CopyOp &copyop)
{
    ...
    setRelatingLibrary((IfcLibrarySelect*)copyop(obj.m_RelatingLibrary.get()));
    return;
}

ClassType_child_implementations(IFC2X3_EXPORT, IfcRelAssociatesLibrary, IfcRelAssociates)
