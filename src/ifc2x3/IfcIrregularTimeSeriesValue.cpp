...
IfcIrregularTimeSeriesValue::IfcIrregularTimeSeriesValue(Step::SPFData *args) : Step::BaseObject(args) {
  m_timeStamp = NULL;
...
const char *IfcIrregularTimeSeriesValue::type() {
...
Step::StepList< Step::RefPtr< IfcValue > > &IfcIrregularTimeSeriesValue::getListValues() {
  if (Step::BaseObject::inited()) {
    return m_listValues;
  }
  else {
...
void IfcIrregularTimeSeriesValue::setListValues(const Step::StepList< Step::RefPtr< IfcValue > > &value) {
  m_listValues = value;
}
...
bool IfcIrregularTimeSeriesValue::init() {
  ...
  if (arg == "$" || arg == "*") {
    ...
    if (arg[0] == '#') {
      m_timeStamp->set(m_model->getObjectById(atoi(arg.c_str() + 1)));
    }
...
IFC2X3_DLL_DEF Step::ClassType IfcIrregularTimeSeriesValue::s_type = new Step::ClassType_class("IfcIrregularTimeSeriesValue");
IfcIrregularTimeSeriesValue_Factory::IfcIrregularTimeSeriesValue_Factory() {
}
...
void IfcIrregularTimeSeriesValue_Factory::clear(bool b) {
}

std::map<Step::StepId,Step::BaseObject*>::iterator IfcIrregularTimeSeriesValue_Factory::begin() {
  return m_idMap.begin();
}

std::map<Step::StepId,Step::BaseObject*>::iterator IfcIrregularTimeSeriesValue_Factory::end() {
  return m_idMap.end();
}

IfcIrregularTimeSeriesValue *IfcIrregularTimeSeriesValue_Factory::get(Step::StepId id) {
  IfcIrregularTimeSeriesValue *value;
  std::map<Step::StepId,Step::BaseObject*>::iterator it = m_idMap.find(id);
  if (it != m_idMap.end()) {
    value = static_cast< IfcIrregularTimeSeriesValue * > (it->second);
  }
  else {
    LOG_ERROR("IfcIrregularTimeSeriesValue_Factory::get() : Key not found.");
    return NULL;
  }
  if (value) {
    return value;
    ...
    return static_cast< IfcIrregularTimeSeriesValue * > (create(id));
  }
}

Step::BaseObject *IfcIrregularTimeSeriesValue_Factory::create(Step::StepId id) {
  IfcIrregularTimeSeriesValue *ret = new IfcIrregularTimeSeriesValue(m_model->getArgs(id));
  ret->set_key(id);
...
Step::BaseObject *IfcIrregularTimeSeriesValue_Factory::create(STEP_MAP<Step::StepId, Step::BaseObjectPtr >::iterator it) {
  IfcIrregularTimeSeriesValue *ret = new IfcIrregularTimeSeriesValue(it->second->getArgs());
...
Step::BaseObject *IfcIrregularTimeSeriesValue_Factory::create(std::map<Step::StepId, Step::BaseObject*>::iterator it) {
  IfcIrregularTimeSeriesValue *ret = new IfcIrregularTimeSeriesValue(m_model->getArgs(it->first));
  ret->set_key(it->first);
  m_model->registerObject(it->first, ret);
  it->second = ret;
  return ret;
...
IfcIrregularTimeSeriesValue *IfcIrregularTimeSeriesValue_Factory::generate() {
  return static_cast< IfcIrregularTimeSeriesValue * > (create(m_model->getNewId()));
}

IfcIrregularTimeSeriesValue *IfcIrregularTimeSeriesValue_Factory::find(Step::StepId id) {
  std::map<Step::StepId,Step::BaseObject*>::iterator it = m_idMap.find(id);
  if (it != m_idMap.end()) {
    return static_cast< IfcIrregularTimeSeriesValue * > (it->second);
  }
  else {
    return NULL;
  }
