...
IfcIrregularTimeSeriesValue::IfcIrregularTimeSeriesValue(Step::Id id, Step::SPFData *args) : 
...
{
    return const_cast<IfcIrregularTimeSeriesValue *>(this)->getTimeStamp();
}
...
{
    return const_cast<IfcIrregularTimeSeriesValue *>(this)->getListValues();
}
...
void IfcIrregularTimeSeriesValue::copy(const IfcIrregularTimeSeriesValue &obj, const CopyOp &copyop)
{
    ...
    setTimeStamp((IfcDateTimeSelect*)copyop(obj.m_TimeStamp.get()));
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcIrregularTimeSeriesValue, Step::BaseEntity)
