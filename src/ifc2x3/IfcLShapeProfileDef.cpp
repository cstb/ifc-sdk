...
bool IfcLShapeProfileDef::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcLShapeProfileDef::s_type("IfcLShapeProfileDef","IfcParameterizedProfileDef");
