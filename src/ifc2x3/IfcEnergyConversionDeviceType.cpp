...
IfcEnergyConversionDeviceType::IfcEnergyConversionDeviceType(Step::Id id, Step::SPFData *args) : 
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcEnergyConversionDeviceType, IfcDistributionFlowElementType)
