...
IfcStructuralLoadStatic::IfcStructuralLoadStatic(Step::Id id, Step::SPFData *args) : 
    IfcStructuralLoad(id, args)
{
}
...
{
    if (IfcStructuralLoad::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcStructuralLoadStatic, IfcStructuralLoad)
