...
IfcPreDefinedCurveFont::IfcPreDefinedCurveFont(Step::SPFData *args) : IfcPreDefinedItem(args) {
}
...
const char *IfcPreDefinedCurveFont::type() {
...
IFC2X3_DLL_DEF Step::ClassType IfcPreDefinedCurveFont::s_type = new Step::ClassType_class("IfcPreDefinedCurveFont");
