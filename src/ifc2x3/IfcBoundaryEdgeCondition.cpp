...
bool IfcBoundaryEdgeCondition::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcBoundaryEdgeCondition::s_type("IfcBoundaryEdgeCondition","IfcBoundaryCondition");
