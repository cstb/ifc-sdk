...
Ifc2DCompositeCurve::Ifc2DCompositeCurve(Step::Id id, Step::SPFData *args) : 
    IfcCompositeCurve(id, args)
{
}
...
{
    if (IfcCompositeCurve::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, Ifc2DCompositeCurve, IfcCompositeCurve)
