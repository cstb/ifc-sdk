...
IfcFlowControllerType::IfcFlowControllerType(Step::SPFData *args) : IfcDistributionFlowElementType(args) {
}
...
const char *IfcFlowControllerType::type() {
...
IFC2X3_DLL_DEF Step::ClassType IfcFlowControllerType::s_type = new Step::ClassType_class("IfcFlowControllerType");
