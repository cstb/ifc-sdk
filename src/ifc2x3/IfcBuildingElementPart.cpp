...
bool IfcBuildingElementPart::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcBuildingElementPart::s_type("IfcBuildingElementPart","IfcBuildingElementComponent");
