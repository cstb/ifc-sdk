...
IfcStructuralConnectionCondition::IfcStructuralConnectionCondition(Step::SPFData *args) : Step::BaseObject(args) {
...
const char *IfcStructuralConnectionCondition::type() {
...
IFC2X3_DLL_DEF Step::ClassType IfcStructuralConnectionCondition::s_type = new Step::ClassType_class("IfcStructuralConnectionCondition");
