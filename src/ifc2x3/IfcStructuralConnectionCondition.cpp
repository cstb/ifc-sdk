...
IfcStructuralConnectionCondition::IfcStructuralConnectionCondition(Step::Id id, Step::SPFData *args) : 
...
{
    return const_cast<IfcStructuralConnectionCondition *>(this)->getName();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcStructuralConnectionCondition, Step::BaseEntity)
