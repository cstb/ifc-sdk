...
IfcWorkSchedule::IfcWorkSchedule(Step::Id id, Step::SPFData *args) : 
    IfcWorkControl(id, args)
{
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcWorkSchedule, IfcWorkControl)
