...
IfcRelAssociatesAppliedValue::IfcRelAssociatesAppliedValue(Step::Id id, Step::SPFData *args) : 
...
{
    return const_cast<IfcRelAssociatesAppliedValue *>(this)->getRelatingAppliedValue();
}
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcRelAssociatesAppliedValue, IfcRelAssociates)
