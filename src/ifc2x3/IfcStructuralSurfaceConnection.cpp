...
IfcStructuralSurfaceConnection::IfcStructuralSurfaceConnection(Step::Id id, Step::SPFData *args) : 
    IfcStructuralConnection(id, args)
{
}
...
{
    if (IfcStructuralConnection::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcStructuralSurfaceConnection, IfcStructuralConnection)
