...
bool IfcTShapeProfileDef::init(Step::InstanciateIf *instanciateIf) {
...
IFC2X3_EXPORT Step::ClassType IfcTShapeProfileDef::s_type("IfcTShapeProfileDef","IfcParameterizedProfileDef");
