...
IfcDraughtingPreDefinedColour::IfcDraughtingPreDefinedColour(Step::Id id, Step::SPFData *args) : 
    IfcPreDefinedColour(id, args)
{
}
...
{
    if (IfcPreDefinedColour::init() == false)
    {
        return false;
    }
    return true;
...
ClassType_child_implementations(IFC2X3_EXPORT, IfcDraughtingPreDefinedColour, IfcPreDefinedColour)
