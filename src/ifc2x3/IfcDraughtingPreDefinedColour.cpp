...
bool IfcDraughtingPreDefinedColour::init(Step::InstanciateIf *instanciateIf) {
    bool status = IfcPreDefinedColour::init(instanciateIf);
    std::string arg;
    if (!status) {
        return false;
    }
...
IFC2X3_EXPORT Step::ClassType IfcDraughtingPreDefinedColour::s_type("IfcDraughtingPreDefinedColour","IfcPreDefinedColour");
