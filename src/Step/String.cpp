...
String::String(const String& str) : std::wstring(str), alphabet(str.alphabet)
{
}

String::String(const wchar_t *str) : std::wstring(str), alphabet(Unknown)
{
}

String::String(const std::wstring& str) : std::wstring(str), alphabet(Unknown)
{
}

String::String(const char *str) : alphabet(Western_European)
{
    buildLatin1(std::string(str));
}

String::String(const std::string &str) : alphabet(Western_European)
{
    buildLatin1(str);
}
...
String String::fromLatin1(const string &str)
{
    String s;
    s.buildLatin1(str);
    return s;
...
void String::buildLatin1(const string &str)
{
...
String String::fromUTF8(const string &str)
{
    ...
    for (; i < str.size(); ++i) {
        ...
        if (((unsigned char)str[i]) < 128) { // 0xxxxxxx
            result += str[i];
        } else if ((str[i]& 0xe0) == 0xc0) { // 110xxxxx 10xxxxxx
            unsigned int value = str[i] & 0x1f;
            value *= 1 << 6;
            value += str[i+1] & 0x3f;
            result += value;
            ++i;
        } else if ((str[i] & 0xf0) == 0xe0) { // 1110xxxx 10xxxxxx 10xxxxxx
            ...
            result += value;
            i+=2;
        } else if ((str[i] & 0xf8) == 0xf0) { // 11110xxx 10xxxxxx 10xxxxxx 10xxxxxx
            unsigned int value = str[i] & 0x0f;
            value *= 1 << 18;
            unsigned int value2 = str[i+1] & 0x3f;
            value2 *= 1 << 12;
...
*/
wchar_t iso8859_5[96] = { 0x00A0, 0x0401, 0x0402, 0x0403, 0x0404, 0x0405, 0x0406, 0x0407, 0x0408, 0x0409, 0x040A, 0x040B, 0x040C, 0x00AD, 0x040E, 0x040F, 0x0410, 0x0411, 0x0412, 0x0413, 0x0414, 0x0415, 0x0416, 0x0417, 0x0418, 0x0419, 0x041A, 0x041B, 0x041C, 0x041D, 0x041E, 0x041F, 0x0420, 0x0421, 0x0422, 0x0423, 0x0424, 0x0425, 0x0426, 0x0427, 0x0428, 0x0429, 0x042A, 0x042B, 0x042C, 0x042D, 0x042E, 0x042F, 0x0430, 0x0431, 0x0432, 0x0433, 0x0434, 0x0435, 0x0436, 0x0437, 0x0438, 0x0439, 0x043A, 0x043B, 0x043C, 0x043D, 0x043E, 0x043F, 0x0440, 0x0441, 0x0442, 0x0443, 0x0444, 0x0445, 0x0446, 0x0447, 0x0448, 0x0449, 0x044A, 0x044B, 0x044C, 0x044D, 0x044E, 0x044F, 0x2116, 0x0451, 0x0452, 0x0453, 0x0454, 0x0455, 0x0456, 0x0457, 0x0458, 0x0459, 0x045A, 0x045B, 0x045C, 0x00A7, 0x045E, 0x045F};
