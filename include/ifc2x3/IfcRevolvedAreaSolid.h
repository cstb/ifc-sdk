...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRevolvedAreaSolid : public Step::InstantiatableEntity, public IfcSweptAreaSolid {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'Angle'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcRevolvedAreaSolid_Factory;

  protected:
    /**
     * @param args
     */
    IfcRevolvedAreaSolid(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcRevolvedAreaSolid(const IfcRevolvedAreaSolid &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRevolvedAreaSolid_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcRevolvedAreaSolid_Factory();
    virtual ~IfcRevolvedAreaSolid_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcRevolvedAreaSolid *get(Step::StepId id);
    /**
     */
    IfcRevolvedAreaSolid *generate();
    /**
     * @param id
     */
    IfcRevolvedAreaSolid *find(Step::StepId id);
