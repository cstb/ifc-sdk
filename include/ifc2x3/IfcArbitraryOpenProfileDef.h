...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcArbitraryOpenProfileDef Entity.
     * 
     */
    ...
    public:
        ...
        /**
         * Gets the value of the explicit attribute 'Curve'.
         * 
         */
        virtual IfcBoundedCurve *getCurve();
        /**
         * (const) Returns the value of the explicit attribute 'Curve'.
         * 
         * @return the value of the explicit attribute 'Curve'
         */
        virtual const IfcBoundedCurve *getCurve() const;
        /**
         * Sets the value of the explicit attribute 'Curve'.
         * 
         * @param value
         */
        virtual void setCurve(const Step::RefPtr< IfcBoundedCurve > &value);
        /**
         * unset the attribute 'Curve'.
         * 
         */
        virtual void unsetCurve();
        /**
         * Test if the attribute 'Curve' is set.
         * 
         * @return true if set, false if unset
         */
        virtual bool testCurve() const;
    ...
    protected:
        ...
        ~IfcArbitraryOpenProfileDef() override;
        /**
         */
        bool init() override;
        /**
