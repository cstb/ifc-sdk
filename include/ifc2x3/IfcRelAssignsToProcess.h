...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRelAssignsToProcess : public Step::InstantiatableEntity, public IfcRelAssigns {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'QuantityInProcess'.
     * 
     ...
     * @param value
     */
    void setQuantityInProcess(const Step::RefPtr< IfcMeasureWithUnit > &value);
    /**
     */
     ...
     */
    virtual bool init();
    friend class IfcRelAssignsToProcess_Factory;

  protected:
    /**
     * @param args
     */
    IfcRelAssignsToProcess(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcRelAssignsToProcess(const IfcRelAssignsToProcess &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRelAssignsToProcess_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcRelAssignsToProcess_Factory();
    virtual ~IfcRelAssignsToProcess_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcRelAssignsToProcess *get(Step::StepId id);
    /**
     */
    IfcRelAssignsToProcess *generate();
    /**
     * @param id
     */
    IfcRelAssignsToProcess *find(Step::StepId id);
