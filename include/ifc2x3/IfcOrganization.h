...
namespace ifc2x3 {
    ...
    public:
         ...
         */
        void push_back(const Step::RefPtr< IfcAddress > &value) throw(std::out_of_range) override;
        /**
         * Remove a value from the aggregate.
         * 
         * @param value The object to act upon.
         */
        iterator erase(const Step::RefPtr< IfcAddress > &value) override;
        /**
