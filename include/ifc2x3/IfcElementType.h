...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'ElementType'.
     * 
     ...
     * @param value
     */
    void setElementType(const IfcLabel &value);
    /**
     */
  ...
  protected:
     ...
     * @param args
     */
    IfcElementType(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcElementType(const IfcElementType &c);
