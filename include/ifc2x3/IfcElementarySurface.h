...
#ifndef IFC2X3_IFCELEMENTARYSURFACE_H
#define IFC2X3_IFCELEMENTARYSURFACE_H
...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcElementarySurface Entity.
     * 
     */
    class IFC2X3_DLL_DEF IfcElementarySurface : public IfcSurface {
    public:
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcElementarySurface(Step::Id id, Step::SPFData *args);
         ...
         * @param copyop
         */
        virtual void copy(const IfcElementarySurface &obj, const CopyOp &copyop);
...
#endif // IFC2X3_IFCELEMENTARYSURFACE_H
