...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcMeasureWithUnit : public Step::InstantiatableEntity, public Step::BaseObject {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'ValueComponent'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'UnitComponent'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcMeasureWithUnit_Factory;

  protected:
    /**
     * @param args
     */
    IfcMeasureWithUnit(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcMeasureWithUnit(const IfcMeasureWithUnit &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcMeasureWithUnit_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcMeasureWithUnit_Factory();
    virtual ~IfcMeasureWithUnit_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcMeasureWithUnit *get(Step::StepId id);
    /**
     */
    IfcMeasureWithUnit *generate();
    /**
     * @param id
     */
    IfcMeasureWithUnit *find(Step::StepId id);
