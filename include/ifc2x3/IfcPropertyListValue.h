...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcPropertyListValue : public Step::InstantiatableEntity, public IfcSimpleProperty {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcPropertyListValue_Factory;

  protected:
    /**
     * @param args
     */
    IfcPropertyListValue(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcPropertyListValue(const IfcPropertyListValue &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcPropertyListValue_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcPropertyListValue_Factory();
    virtual ~IfcPropertyListValue_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcPropertyListValue *get(Step::StepId id);
    /**
     */
    IfcPropertyListValue *generate();
    /**
     * @param id
     */
    IfcPropertyListValue *find(Step::StepId id);
