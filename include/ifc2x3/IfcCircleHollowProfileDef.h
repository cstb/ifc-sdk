...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcCircleHollowProfileDef_Factory;

  protected:
    /**
     * @param args
     */
    IfcCircleHollowProfileDef(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcCircleHollowProfileDef(const IfcCircleHollowProfileDef &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcCircleHollowProfileDef_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcCircleHollowProfileDef_Factory();
    virtual ~IfcCircleHollowProfileDef_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcCircleHollowProfileDef *get(Step::StepId id);
    /**
     */
    IfcCircleHollowProfileDef *generate();
    /**
     * @param id
     */
    IfcCircleHollowProfileDef *find(Step::StepId id);
