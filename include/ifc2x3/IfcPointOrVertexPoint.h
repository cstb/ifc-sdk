...
{
    /**
     * Generated class for the IfcPointOrVertexPoint Select type.
     *
     */
    class IFC2X3_EXPORT IfcPointOrVertexPoint : public Step::BaseObject
    ...
    private:
        ...
        IfcPointOrVertexPoint_union m_union;
    };
} // namespace ifc2x3