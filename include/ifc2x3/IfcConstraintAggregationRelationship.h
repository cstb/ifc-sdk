...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcConstraintAggregationRelationship : public Step::InstantiatableEntity, public Step::BaseObject {
  public:
    /**
     ...
     */
    Step::StepList< Step::RefPtr< IfcConstraint > > &getRelatedConstraints();
    /**
     * Sets the value of the explicit attribute 'RelatedConstraints'.
     * 
     * @param value
     */
    void setRelatedConstraints(const Step::StepList< Step::RefPtr< IfcConstraint > > &value);
    /**
     * (non-const) Returns the value of the explicit attribute 'LogicalAggregator'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcConstraintAggregationRelationship_Factory;

  protected:
    /**
     * @param args
     */
    IfcConstraintAggregationRelationship(Step::SPFData *args);
  ...
  private:
    ...
    Step::StepList< Step::RefPtr< IfcConstraint > > m_relatedConstraints;
    IfcLogicalOperatorEnum m_logicalAggregator;
    /**
     * @param c
     */
    IfcConstraintAggregationRelationship(const IfcConstraintAggregationRelationship &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcConstraintAggregationRelationship_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcConstraintAggregationRelationship_Factory();
    virtual ~IfcConstraintAggregationRelationship_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcConstraintAggregationRelationship *get(Step::StepId id);
    /**
     */
    IfcConstraintAggregationRelationship *generate();
    /**
     * @param id
     */
    IfcConstraintAggregationRelationship *find(Step::StepId id);
