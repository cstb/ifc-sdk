...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcStair : public Step::InstantiatableEntity, public IfcBuildingElement {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcStair_Factory;

  protected:
    /**
     * @param args
     */
    IfcStair(Step::SPFData *args);
    virtual ~IfcStair();
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcStair_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcStair_Factory();
    virtual ~IfcStair_Factory();
    /**
     * @param b
     */
    void clear(bool b);
