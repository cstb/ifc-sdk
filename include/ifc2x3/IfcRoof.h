...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRoof : public Step::InstantiatableEntity, public IfcBuildingElement {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcRoof_Factory;

  protected:
    /**
     * @param args
     */
    IfcRoof(Step::SPFData *args);
    virtual ~IfcRoof();
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRoof_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcRoof_Factory();
    virtual ~IfcRoof_Factory();
    /**
     * @param b
     */
    void clear(bool b);
