...
{
    /**
     * Generated class for the IfcHatchLineDistanceSelect Select type.
     *
     */
    class IFC2X3_EXPORT IfcHatchLineDistanceSelect : public Step::BaseObject
    ...
    private:
        ...
        IfcHatchLineDistanceSelect_union m_union;
    };
} // namespace ifc2x3