...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'FeatureLength'.
     * 
  ...
  protected:
     ...
     * @param args
     */
    IfcEdgeFeature(Step::SPFData *args);
    virtual ~IfcEdgeFeature();

  private:
    static Step::ClassType s_type;
    Real m_featureLength;
    /**
     * @param c
     */
    IfcEdgeFeature(const IfcEdgeFeature &c);
