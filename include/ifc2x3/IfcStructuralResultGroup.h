...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual Step::RefPtr< Inverse_Set_IfcStructuralAnalysisModel_0_1 > &getResultGroupFor();
        /**
         ...
         */
        const virtual Step::RefPtr< Inverse_Set_IfcStructuralAnalysisModel_0_1 > &getResultGroupFor() const;
        /**
