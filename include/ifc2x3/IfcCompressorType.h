...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcCompressorType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcCompressorTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcCompressorTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcCompressorTypeEnum value);
        /**
