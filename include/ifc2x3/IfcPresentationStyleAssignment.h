...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcPresentationStyleAssignment Entity.
     * 
     */
    class IFC2X3_EXPORT IfcPresentationStyleAssignment : public Step::BaseEntity {
    public:
        /**
    ...
    protected:
        ...
        ~IfcPresentationStyleAssignment() override;
        /**
         */
        bool init() override;
        /**
