...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcCircleProfileDef Entity.
     * 
     */
    class IFC2X3_DLL_DEF IfcCircleProfileDef : public IfcParameterizedProfileDef {
    public:
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcCircleProfileDef(Step::Id id, Step::SPFData *args);
         ...
         * @param copyop
         */
        virtual void copy(const IfcCircleProfileDef &obj, const CopyOp &copyop);
