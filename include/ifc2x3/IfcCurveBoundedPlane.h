...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcCurveBoundedPlane_Factory;

  protected:
    /**
     * @param args
     */
    IfcCurveBoundedPlane(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcCurveBoundedPlane(const IfcCurveBoundedPlane &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcCurveBoundedPlane_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcCurveBoundedPlane_Factory();
    virtual ~IfcCurveBoundedPlane_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcCurveBoundedPlane *get(Step::StepId id);
    /**
     */
    IfcCurveBoundedPlane *generate();
    /**
     * @param id
     */
    IfcCurveBoundedPlane *find(Step::StepId id);
