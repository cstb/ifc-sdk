...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'VoidsElements'.
     * 
     * @return the value of the explicit attribute 'VoidsElements'
     */
    IfcRelVoidsElement *getVoidsElements();
    /**
     * Sets the value of the explicit attribute 'VoidsElements'.
     * 
     * @param value
     */
    void setVoidsElements(const Step::RefPtr< IfcRelVoidsElement > &value);
    /**
     */
  ...
  protected:
     ...
     * @param args
     */
    IfcFeatureElementSubtraction(Step::SPFData *args);
    virtual ~IfcFeatureElementSubtraction();

  private:
    static Step::ClassType s_type;
    Step::RefPtr< IfcRelVoidsElement > m_voidsElements;
    /**
     * @param c
     */
    IfcFeatureElementSubtraction(const IfcFeatureElementSubtraction &c);
