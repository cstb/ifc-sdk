...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcMaterialProperties : public Step::BaseObject {
  public:
    /**
  ...
  protected:
     ...
     * @param args
     */
    IfcMaterialProperties(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcMaterialProperties(const IfcMaterialProperties &c);
