...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcSphere Entity.
     * 
     */
    class IFC2X3_DLL_DEF IfcSphere : public IfcCsgPrimitive3D {
    public:
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcSphere(Step::Id id, Step::SPFData *args);
        virtual ~IfcSphere();
        /**
         */
        virtual bool init();
         ...
         * @param copyop
         */
        virtual void copy(const IfcSphere &obj, const CopyOp &copyop);
