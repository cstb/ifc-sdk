...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcSIUnit : public Step::InstantiatableEntity, public IfcNamedUnit {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'Prefix'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcSIUnit_Factory;

  protected:
    /**
     * @param args
     */
    IfcSIUnit(Step::SPFData *args);
    virtual ~IfcSIUnit();
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcSIUnit_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcSIUnit_Factory();
    virtual ~IfcSIUnit_Factory();
    /**
     * @param b
     */
    void clear(bool b);
