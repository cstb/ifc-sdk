...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcStructuralSurfaceMember : public Step::InstantiatableEntity, public IfcStructuralMember {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcStructuralSurfaceMember_Factory;

  protected:
    /**
     * @param args
     */
    IfcStructuralSurfaceMember(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcStructuralSurfaceMember(const IfcStructuralSurfaceMember &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcStructuralSurfaceMember_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcStructuralSurfaceMember_Factory();
    virtual ~IfcStructuralSurfaceMember_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcStructuralSurfaceMember *get(Step::StepId id);
    /**
     */
    IfcStructuralSurfaceMember *generate();
    /**
     * @param id
     */
    IfcStructuralSurfaceMember *find(Step::StepId id);
