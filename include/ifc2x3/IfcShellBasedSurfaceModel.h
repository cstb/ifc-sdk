...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcShellBasedSurfaceModel Entity.
     * 
     */
    ...
    public:
        ...
        /**
         * unset the attribute 'SbsmBoundary'.
         * 
         */
        virtual void unsetSbsmBoundary();
        /**
         * Test if the attribute 'SbsmBoundary' is set.
         * 
         * @return true if set, false if unset
         */
        virtual bool testSbsmBoundary() const;
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcShellBasedSurfaceModel(Step::Id id, Step::SPFData *args);
        ~IfcShellBasedSurfaceModel() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcShellBasedSurfaceModel &obj, const CopyOp &copyop);
