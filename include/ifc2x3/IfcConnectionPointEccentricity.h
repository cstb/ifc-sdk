...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'EccentricityInX'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'EccentricityInY'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'EccentricityInZ'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcConnectionPointEccentricity_Factory;

  protected:
    /**
     * @param args
     */
    IfcConnectionPointEccentricity(Step::SPFData *args);
    virtual ~IfcConnectionPointEccentricity();

  private:
    static Step::ClassType s_type;
    Real m_eccentricityInX;
    Real m_eccentricityInY;
    Real m_eccentricityInZ;
    /**
     * @param c
     */
    IfcConnectionPointEccentricity(const IfcConnectionPointEccentricity &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcConnectionPointEccentricity_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcConnectionPointEccentricity_Factory();
    virtual ~IfcConnectionPointEccentricity_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcConnectionPointEccentricity *get(Step::StepId id);
    /**
     */
    IfcConnectionPointEccentricity *generate();
    /**
     * @param id
     */
    IfcConnectionPointEccentricity *find(Step::StepId id);
