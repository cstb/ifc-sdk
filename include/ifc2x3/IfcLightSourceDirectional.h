...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcLightSourceDirectional Entity.
     * 
     */
    class IFC2X3_DLL_DEF IfcLightSourceDirectional : public IfcLightSource {
    public:
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcLightSourceDirectional(Step::Id id, Step::SPFData *args);
         ...
         * @param copyop
         */
        virtual void copy(const IfcLightSourceDirectional &obj, const CopyOp &copyop);
