...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcConnectionSurfaceGeometry : public Step::InstantiatableEntity, public IfcConnectionGeometry {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'SurfaceOnRelatingElement'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'SurfaceOnRelatedElement'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcConnectionSurfaceGeometry_Factory;

  protected:
    /**
     * @param args
     */
    IfcConnectionSurfaceGeometry(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcConnectionSurfaceGeometry(const IfcConnectionSurfaceGeometry &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcConnectionSurfaceGeometry_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcConnectionSurfaceGeometry_Factory();
    virtual ~IfcConnectionSurfaceGeometry_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcConnectionSurfaceGeometry *get(Step::StepId id);
    /**
     */
    IfcConnectionSurfaceGeometry *generate();
    /**
     * @param id
     */
    IfcConnectionSurfaceGeometry *find(Step::StepId id);
