...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'RelatingClassification'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcRelAssociatesClassification_Factory;

  protected:
    /**
     * @param args
     */
    IfcRelAssociatesClassification(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcRelAssociatesClassification(const IfcRelAssociatesClassification &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRelAssociatesClassification_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcRelAssociatesClassification_Factory();
    virtual ~IfcRelAssociatesClassification_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcRelAssociatesClassification *get(Step::StepId id);
    /**
     */
    IfcRelAssociatesClassification *generate();
    /**
     * @param id
     */
    IfcRelAssociatesClassification *find(Step::StepId id);
