...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcStructuralLinearActionVarying_Factory;

  protected:
    /**
     * @param args
     */
    IfcStructuralLinearActionVarying(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcStructuralLinearActionVarying(const IfcStructuralLinearActionVarying &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcStructuralLinearActionVarying_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcStructuralLinearActionVarying_Factory();
    virtual ~IfcStructuralLinearActionVarying_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcStructuralLinearActionVarying *get(Step::StepId id);
    /**
     */
    IfcStructuralLinearActionVarying *generate();
    /**
     * @param id
     */
    IfcStructuralLinearActionVarying *find(Step::StepId id);
