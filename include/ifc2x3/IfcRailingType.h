...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcRailingType Entity.
     * 
     */
    ...
    protected:
         ...
         * @param args
         */
        IfcRailingType(Step::Id id, Step::SPFData *args);
         ...
         * @param copyop
         */
        virtual void copy(const IfcRailingType &obj, const CopyOp &copyop);
