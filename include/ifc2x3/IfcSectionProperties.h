...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcSectionProperties : public Step::InstantiatableEntity, public Step::BaseObject {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'SectionType'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'StartProfile'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'EndProfile'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcSectionProperties_Factory;

  protected:
    /**
     * @param args
     */
    IfcSectionProperties(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcSectionProperties(const IfcSectionProperties &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcSectionProperties_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcSectionProperties_Factory();
    virtual ~IfcSectionProperties_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcSectionProperties *get(Step::StepId id);
    /**
     */
    IfcSectionProperties *generate();
    /**
     * @param id
     */
    IfcSectionProperties *find(Step::StepId id);
