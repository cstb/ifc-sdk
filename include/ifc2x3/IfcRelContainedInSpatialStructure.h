...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRelContainedInSpatialStructure : public Step::InstantiatableEntity, public IfcRelConnects {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcRelContainedInSpatialStructure_Factory;

  protected:
    /**
     * @param args
     */
    IfcRelContainedInSpatialStructure(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcRelContainedInSpatialStructure(const IfcRelContainedInSpatialStructure &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRelContainedInSpatialStructure_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcRelContainedInSpatialStructure_Factory();
    virtual ~IfcRelContainedInSpatialStructure_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcRelContainedInSpatialStructure *get(Step::StepId id);
    /**
     */
    IfcRelContainedInSpatialStructure *generate();
    /**
     * @param id
     */
    IfcRelContainedInSpatialStructure *find(Step::StepId id);
