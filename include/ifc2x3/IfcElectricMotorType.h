...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual IfcElectricMotorTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcElectricMotorTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcElectricMotorTypeEnum value);
        /**
