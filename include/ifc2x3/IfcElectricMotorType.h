...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcElectricMotorType_Factory;

  protected:
    /**
     * @param args
     */
    IfcElectricMotorType(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcElectricMotorType(const IfcElectricMotorType &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcElectricMotorType_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcElectricMotorType_Factory();
    virtual ~IfcElectricMotorType_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcElectricMotorType *get(Step::StepId id);
    /**
     */
    IfcElectricMotorType *generate();
    /**
     * @param id
     */
    IfcElectricMotorType *find(Step::StepId id);
