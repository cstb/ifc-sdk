...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcDoor : public Step::InstantiatableEntity, public IfcBuildingElement {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcDoor_Factory;

  protected:
    /**
     * @param args
     */
    IfcDoor(Step::SPFData *args);
    virtual ~IfcDoor();
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcDoor_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcDoor_Factory();
    virtual ~IfcDoor_Factory();
    /**
     * @param b
     */
    void clear(bool b);
