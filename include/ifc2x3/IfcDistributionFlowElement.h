...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual Step::RefPtr< Inverse_Set_IfcRelFlowControlElements_0_1 > &getHasControlElements();
        /**
         ...
         */
        const virtual Step::RefPtr< Inverse_Set_IfcRelFlowControlElements_0_1 > &getHasControlElements() const;
        /**
