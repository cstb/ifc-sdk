...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcTimeSeriesValue : public Step::InstantiatableEntity, public Step::BaseObject {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcTimeSeriesValue_Factory;

  protected:
    /**
     * @param args
     */
    IfcTimeSeriesValue(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcTimeSeriesValue(const IfcTimeSeriesValue &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcTimeSeriesValue_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcTimeSeriesValue_Factory();
    virtual ~IfcTimeSeriesValue_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcTimeSeriesValue *get(Step::StepId id);
    /**
     */
    IfcTimeSeriesValue *generate();
    /**
     * @param id
     */
    IfcTimeSeriesValue *find(Step::StepId id);
