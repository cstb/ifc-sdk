...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcConversionBasedUnit : public Step::InstantiatableEntity, public IfcNamedUnit {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'ConversionFactor'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcConversionBasedUnit_Factory;

  protected:
    /**
     * @param args
     */
    IfcConversionBasedUnit(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcConversionBasedUnit(const IfcConversionBasedUnit &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcConversionBasedUnit_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcConversionBasedUnit_Factory();
    virtual ~IfcConversionBasedUnit_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcConversionBasedUnit *get(Step::StepId id);
    /**
     */
    IfcConversionBasedUnit *generate();
    /**
     * @param id
     */
    IfcConversionBasedUnit *find(Step::StepId id);
