...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcLightFixtureType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcLightFixtureTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcLightFixtureTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcLightFixtureTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcLightFixtureType(Step::Id id, Step::SPFData *args);
        ~IfcLightFixtureType() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcLightFixtureType &obj, const CopyOp &copyop);
