...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcDerivedUnitElement : public Step::InstantiatableEntity, public Step::BaseObject {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'Exponent'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcDerivedUnitElement_Factory;

  protected:
    /**
     * @param args
     */
    IfcDerivedUnitElement(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcDerivedUnitElement(const IfcDerivedUnitElement &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcDerivedUnitElement_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcDerivedUnitElement_Factory();
    virtual ~IfcDerivedUnitElement_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcDerivedUnitElement *get(Step::StepId id);
    /**
     */
    IfcDerivedUnitElement *generate();
    /**
     * @param id
     */
    IfcDerivedUnitElement *find(Step::StepId id);
