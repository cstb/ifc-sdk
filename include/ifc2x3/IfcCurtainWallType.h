...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcCurtainWallType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcCurtainWallTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcCurtainWallTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcCurtainWallTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcCurtainWallType(Step::Id id, Step::SPFData *args);
        ~IfcCurtainWallType() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcCurtainWallType &obj, const CopyOp &copyop);
