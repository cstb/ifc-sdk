...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcWindow : public Step::InstantiatableEntity, public IfcBuildingElement {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcWindow_Factory;

  protected:
    /**
     * @param args
     */
    IfcWindow(Step::SPFData *args);
    virtual ~IfcWindow();
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcWindow_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcWindow_Factory();
    virtual ~IfcWindow_Factory();
    /**
     * @param b
     */
    void clear(bool b);
