...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcFlowInstrumentType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcFlowInstrumentTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcFlowInstrumentTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcFlowInstrumentTypeEnum value);
        /**
    ...
    protected:
        ...
        ~IfcFlowInstrumentType() override;
        /**
         */
        bool init() override;
        /**
