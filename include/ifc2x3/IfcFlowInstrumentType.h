...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcFlowInstrumentType_Factory;

  protected:
    /**
     * @param args
     */
    IfcFlowInstrumentType(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcFlowInstrumentType(const IfcFlowInstrumentType &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcFlowInstrumentType_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcFlowInstrumentType_Factory();
    virtual ~IfcFlowInstrumentType_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcFlowInstrumentType *get(Step::StepId id);
    /**
     */
    IfcFlowInstrumentType *generate();
    /**
     * @param id
     */
    IfcFlowInstrumentType *find(Step::StepId id);
