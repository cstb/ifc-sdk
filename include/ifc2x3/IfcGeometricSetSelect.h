...
{
    /**
     * Generated class for the IfcGeometricSetSelect Select type.
     *
     */
    class IFC2X3_EXPORT IfcGeometricSetSelect : public Step::BaseObject
    ...
    private:
        ...
        IfcGeometricSetSelect_union m_union;
    };
} // namespace ifc2x3