...
{
    /**
     * Generated class for the IfcStructuralActivityAssignmentSelect Select type.
     *
     */
    class IFC2X3_EXPORT IfcStructuralActivityAssignmentSelect : public Step::BaseObject
    ...
    public:
        ...
        IfcStructuralActivityAssignmentSelect_select currentType() const;

        void deleteUnion();

        void set(Step::BaseObject *v);

        IfcStructuralItem *getIfcStructuralItem() const;
        void setIfcStructuralItem(IfcStructuralItem *value);

        IfcElement *getIfcElement() const;
    ...
    private:
        ...
        IfcStructuralActivityAssignmentSelect_union m_union;
    };
} // namespace ifc2x3