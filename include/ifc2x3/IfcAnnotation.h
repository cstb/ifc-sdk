...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcAnnotation : public Step::InstantiatableEntity, public IfcProduct {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcAnnotation_Factory;

  protected:
    /**
     * @param args
     */
    IfcAnnotation(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcAnnotation(const IfcAnnotation &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcAnnotation_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcAnnotation_Factory();
    virtual ~IfcAnnotation_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcAnnotation *get(Step::StepId id);
    /**
     */
    IfcAnnotation *generate();
    /**
     * @param id
     */
    IfcAnnotation *find(Step::StepId id);
