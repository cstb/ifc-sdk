...
namespace ifc2x3 {
    ...
    protected:
        ...
        ~IfcGeometricRepresentationSubContext() override;
        /**
         */
        bool init() override;
        /**
