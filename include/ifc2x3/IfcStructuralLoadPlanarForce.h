...
namespace ifc2x3
{
    ...
    class IFC2X3_EXPORT IfcStructuralLoadPlanarForce : public IfcStructuralLoadStatic
    {
        ...
        // Attributes
        IfcPlanarForceMeasure m_PlanarForceX;
        IfcPlanarForceMeasure m_PlanarForceY;
        IfcPlanarForceMeasure m_PlanarForceZ;
    ...
    public:
        ...
        /// Attribute PlanarForceX
        /// @{
        virtual IfcPlanarForceMeasure getPlanarForceX();
        virtual IfcPlanarForceMeasure getPlanarForceX() const;
        ...
        /// Attribute PlanarForceY
        /// @{
        virtual IfcPlanarForceMeasure getPlanarForceY();
        virtual IfcPlanarForceMeasure getPlanarForceY() const;
        ...
        /// Attribute PlanarForceZ
        /// @{
        virtual IfcPlanarForceMeasure getPlanarForceZ();
        virtual IfcPlanarForceMeasure getPlanarForceZ() const;
