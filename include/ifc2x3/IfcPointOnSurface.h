...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcPointOnSurface : public Step::InstantiatableEntity, public IfcPoint {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'PointParameterU'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'PointParameterV'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcPointOnSurface_Factory;

  protected:
    /**
     * @param args
     */
    IfcPointOnSurface(Step::SPFData *args);
    virtual ~IfcPointOnSurface();

  private:
    static Step::ClassType s_type;
    Step::RefPtr< IfcSurface > m_basisSurface;
    Real m_pointParameterU;
    Real m_pointParameterV;
    /**
     * @param c
     */
    IfcPointOnSurface(const IfcPointOnSurface &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcPointOnSurface_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcPointOnSurface_Factory();
    virtual ~IfcPointOnSurface_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcPointOnSurface *get(Step::StepId id);
    /**
     */
    IfcPointOnSurface *generate();
    /**
     * @param id
     */
    IfcPointOnSurface *find(Step::StepId id);
