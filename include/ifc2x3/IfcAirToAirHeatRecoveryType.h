...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcAirToAirHeatRecoveryType_Factory;

  protected:
    /**
     * @param args
     */
    IfcAirToAirHeatRecoveryType(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcAirToAirHeatRecoveryType(const IfcAirToAirHeatRecoveryType &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcAirToAirHeatRecoveryType_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcAirToAirHeatRecoveryType_Factory();
    virtual ~IfcAirToAirHeatRecoveryType_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcAirToAirHeatRecoveryType *get(Step::StepId id);
    /**
     */
    IfcAirToAirHeatRecoveryType *generate();
    /**
     * @param id
     */
    IfcAirToAirHeatRecoveryType *find(Step::StepId id);
