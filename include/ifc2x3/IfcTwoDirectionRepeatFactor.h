...
namespace ifc2x3 {
    ...
    public:
        ...
        /**
         * Gets the value of the explicit attribute 'SecondRepeatFactor'.
         * 
         */
        virtual IfcVector *getSecondRepeatFactor();
        /**
         * (const) Returns the value of the explicit attribute 'SecondRepeatFactor'.
         * 
         * @return the value of the explicit attribute 'SecondRepeatFactor'
         */
        virtual const IfcVector *getSecondRepeatFactor() const;
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcTwoDirectionRepeatFactor(Step::Id id, Step::SPFData *args);
        ~IfcTwoDirectionRepeatFactor() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcTwoDirectionRepeatFactor &obj, const CopyOp &copyop);
