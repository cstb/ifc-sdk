...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRibPlateProfileProperties : public Step::InstantiatableEntity, public IfcProfileProperties {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'Thickness'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'RibHeight'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'RibWidth'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'RibSpacing'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'Direction'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcRibPlateProfileProperties_Factory;

  protected:
    /**
     * @param args
     */
    IfcRibPlateProfileProperties(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcRibPlateProfileProperties(const IfcRibPlateProfileProperties &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRibPlateProfileProperties_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcRibPlateProfileProperties_Factory();
    virtual ~IfcRibPlateProfileProperties_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcRibPlateProfileProperties *get(Step::StepId id);
    /**
     */
    IfcRibPlateProfileProperties *generate();
    /**
     * @param id
     */
    IfcRibPlateProfileProperties *find(Step::StepId id);
