...
namespace ifc2x3
{
    ...
    class IFC2X3_EXPORT IfcRelaxation : public Step::BaseEntity
    {
        ...
        // Attributes
        IfcNormalisedRatioMeasure m_RelaxationValue;
        IfcNormalisedRatioMeasure m_InitialStress;
    ...
    public:
        ...
        /// Attribute RelaxationValue
        /// @{
        virtual IfcNormalisedRatioMeasure getRelaxationValue();
        virtual IfcNormalisedRatioMeasure getRelaxationValue() const;
        ...
        /// Attribute InitialStress
        /// @{
        virtual IfcNormalisedRatioMeasure getInitialStress();
        virtual IfcNormalisedRatioMeasure getInitialStress() const;
