...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcSoundValue : public Step::InstantiatableEntity, public IfcPropertySetDefinition {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'SoundLevelTimeSeries'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'Frequency'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'SoundLevelSingleValue'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcSoundValue_Factory;

  protected:
    /**
     * @param args
     */
    IfcSoundValue(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcSoundValue(const IfcSoundValue &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcSoundValue_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcSoundValue_Factory();
    virtual ~IfcSoundValue_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcSoundValue *get(Step::StepId id);
    /**
     */
    IfcSoundValue *generate();
    /**
     * @param id
     */
    IfcSoundValue *find(Step::StepId id);
