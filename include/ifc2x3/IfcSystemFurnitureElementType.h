...
namespace ifc2x3 {
    ...
    protected:
         ...
         * @param args
         */
        IfcSystemFurnitureElementType(Step::Id id, Step::SPFData *args);
        ~IfcSystemFurnitureElementType() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcSystemFurnitureElementType &obj, const CopyOp &copyop);
