...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual IfcPlateTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcPlateTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcPlateTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcPlateType(Step::Id id, Step::SPFData *args);
        ~IfcPlateType() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcPlateType &obj, const CopyOp &copyop);
