...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcPlateType_Factory;

  protected:
    /**
     * @param args
     */
    IfcPlateType(Step::SPFData *args);
    virtual ~IfcPlateType();

  private:
    static Step::ClassType s_type;
    IfcPlateTypeEnum m_predefinedType;
    /**
     * @param c
     */
    IfcPlateType(const IfcPlateType &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcPlateType_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcPlateType_Factory();
    virtual ~IfcPlateType_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcPlateType *get(Step::StepId id);
    /**
     */
    IfcPlateType *generate();
    /**
     * @param id
     */
    IfcPlateType *find(Step::StepId id);
