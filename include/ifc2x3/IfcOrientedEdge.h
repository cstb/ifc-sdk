...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'EdgeElement'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcOrientedEdge_Factory;

  protected:
    /**
     * @param args
     */
    IfcOrientedEdge(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcOrientedEdge(const IfcOrientedEdge &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcOrientedEdge_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcOrientedEdge_Factory();
    virtual ~IfcOrientedEdge_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcOrientedEdge *get(Step::StepId id);
    /**
     */
    IfcOrientedEdge *generate();
    /**
     * @param id
     */
    IfcOrientedEdge *find(Step::StepId id);
