...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcElectricTimeControlType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcElectricTimeControlTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcElectricTimeControlTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcElectricTimeControlTypeEnum value);
        /**
    ...
    protected:
        ...
        ~IfcElectricTimeControlType() override;
        /**
         */
        bool init() override;
        /**
