...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcElectricTimeControlType_Factory;

  protected:
    /**
     * @param args
     */
    IfcElectricTimeControlType(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcElectricTimeControlType(const IfcElectricTimeControlType &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcElectricTimeControlType_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcElectricTimeControlType_Factory();
    virtual ~IfcElectricTimeControlType_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcElectricTimeControlType *get(Step::StepId id);
    /**
     */
    IfcElectricTimeControlType *generate();
    /**
     * @param id
     */
    IfcElectricTimeControlType *find(Step::StepId id);
