...
namespace ifc2x3
{
    ...
    class IFC2X3_EXPORT IfcServiceLife : public IfcControl
    {
        ...
        IfcTimeMeasure m_ServiceLifeDuration;
    ...
    public:
        ...
        /// Attribute ServiceLifeType
        /// @{
        virtual IfcServiceLifeTypeEnum getServiceLifeType();
        virtual IfcServiceLifeTypeEnum getServiceLifeType() const;
        ...
        /// Attribute ServiceLifeDuration
        /// @{
        virtual IfcTimeMeasure getServiceLifeDuration();
        virtual IfcTimeMeasure getServiceLifeDuration() const;
