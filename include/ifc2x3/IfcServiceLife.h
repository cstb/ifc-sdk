...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcServiceLife : public Step::InstantiatableEntity, public IfcControl {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'ServiceLifeType'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'ServiceLifeDuration'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcServiceLife_Factory;

  protected:
    /**
     * @param args
     */
    IfcServiceLife(Step::SPFData *args);
    virtual ~IfcServiceLife();

  private:
    static Step::ClassType s_type;
    IfcServiceLifeTypeEnum m_serviceLifeType;
    Real m_serviceLifeDuration;
    /**
     * @param c
     */
    IfcServiceLife(const IfcServiceLife &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcServiceLife_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcServiceLife_Factory();
    virtual ~IfcServiceLife_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcServiceLife *get(Step::StepId id);
    /**
     */
    IfcServiceLife *generate();
    /**
     * @param id
     */
    IfcServiceLife *find(Step::StepId id);
