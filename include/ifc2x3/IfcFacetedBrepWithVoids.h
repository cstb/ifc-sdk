...
namespace ifc2x3 {
     ...
     * 
     */
    class IFC2X3_DLL_DEF IfcFacetedBrepWithVoids : public IfcManifoldSolidBrep {
    public:
        /**
        ...
        /**
         * Gets the value of the explicit attribute 'Voids'.
         * 
         */
        virtual Set_IfcClosedShell_1_n &getVoids();
        /**
         * (const) Returns the value of the explicit attribute 'Voids'.
         * 
        ...
        /**
         * unset the attribute 'Voids'.
         * 
         */
        virtual void unsetVoids();
        /**
         * Test if the attribute 'Voids' is set.
         * 
