...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual IfcPositiveLengthMeasure getBaseWidth2();
        /**
         * (const) Returns the value of the explicit attribute 'BaseWidth2'.
         * 
         * @return the value of the explicit attribute 'BaseWidth2'
         */
        virtual const IfcPositiveLengthMeasure getBaseWidth2() const;
        /**
         ...
         * 
         */
        virtual IfcPositiveLengthMeasure getBaseWidth4();
        /**
         * (const) Returns the value of the explicit attribute 'BaseWidth4'.
         * 
         * @return the value of the explicit attribute 'BaseWidth4'
         */
        virtual const IfcPositiveLengthMeasure getBaseWidth4() const;
        /**
         ...
         * 
         */
        virtual IfcPositiveLengthMeasure getBaseDepth3();
        /**
         * (const) Returns the value of the explicit attribute 'BaseDepth3'.
         * 
         * @return the value of the explicit attribute 'BaseDepth3'
         */
        virtual const IfcPositiveLengthMeasure getBaseDepth3() const;
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcCraneRailAShapeProfileDef(Step::Id id, Step::SPFData *args);
        ~IfcCraneRailAShapeProfileDef() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcCraneRailAShapeProfileDef &obj, const CopyOp &copyop);
