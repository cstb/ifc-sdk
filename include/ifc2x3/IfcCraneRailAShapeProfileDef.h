...
namespace ifc2x3
{
    ...
    class IFC2X3_EXPORT IfcCraneRailAShapeProfileDef : public IfcParameterizedProfileDef
    {
        ...
        IfcPositiveLengthMeasure m_BaseWidth2;
        ...
        IfcPositiveLengthMeasure m_BaseWidth4;
        IfcPositiveLengthMeasure m_BaseDepth1;
        IfcPositiveLengthMeasure m_BaseDepth2;
        IfcPositiveLengthMeasure m_BaseDepth3;
    ...
    public:
        ...
        /// Attribute BaseWidth2
        /// @{
        virtual IfcPositiveLengthMeasure getBaseWidth2();
        virtual IfcPositiveLengthMeasure getBaseWidth2() const;
        ...
        /// Attribute BaseWidth4
        /// @{
        virtual IfcPositiveLengthMeasure getBaseWidth4();
        virtual IfcPositiveLengthMeasure getBaseWidth4() const;
        ...
        /// Attribute BaseDepth3
        /// @{
        virtual IfcPositiveLengthMeasure getBaseDepth3();
        virtual IfcPositiveLengthMeasure getBaseDepth3() const;
