...
#ifndef IFC2X3_IFCCRANERAILASHAPEPROFILEDEF_H
#define IFC2X3_IFCCRANERAILASHAPEPROFILEDEF_H
...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcCraneRailAShapeProfileDef : public Step::InstantiatableEntity, public IfcParameterizedProfileDef {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'BaseWidth2'.
     * 
     * @return the value of the explicit attribute 'BaseWidth2'
     */
    IfcPositiveLengthMeasure getBaseWidth2();
    /**
     * Sets the value of the explicit attribute 'BaseWidth2'.
     * 
     * @param value
     */
    void setBaseWidth2(IfcPositiveLengthMeasure value);
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'BaseWidth4'.
     * 
     * @return the value of the explicit attribute 'BaseWidth4'
     */
    IfcPositiveLengthMeasure getBaseWidth4();
    /**
     * Sets the value of the explicit attribute 'BaseWidth4'.
     * 
     * @param value
     */
    void setBaseWidth4(IfcPositiveLengthMeasure value);
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'BaseDepth3'.
     * 
     * @return the value of the explicit attribute 'BaseDepth3'
     */
    IfcPositiveLengthMeasure getBaseDepth3();
    /**
     * Sets the value of the explicit attribute 'BaseDepth3'.
     * 
     * @param value
     */
    void setBaseDepth3(IfcPositiveLengthMeasure value);
    /**
     ...
     */
    virtual bool init();
    friend class IfcCraneRailAShapeProfileDef_Factory;

  protected:
    /**
     * @param args
     */
    IfcCraneRailAShapeProfileDef(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcCraneRailAShapeProfileDef(const IfcCraneRailAShapeProfileDef &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcCraneRailAShapeProfileDef_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcCraneRailAShapeProfileDef_Factory();
    virtual ~IfcCraneRailAShapeProfileDef_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcCraneRailAShapeProfileDef *get(Step::StepId id);
    /**
     */
    IfcCraneRailAShapeProfileDef *generate();
    /**
     * @param id
     */
    IfcCraneRailAShapeProfileDef *find(Step::StepId id);
...
#endif // IFC2X3_IFCCRANERAILASHAPEPROFILEDEF_H
