...
{
    /**
     * Generated class for the IfcSurfaceOrFaceSurface Select type.
     *
     */
    class IFC2X3_EXPORT IfcSurfaceOrFaceSurface : public Step::BaseObject
    ...
    private:
        ...
        IfcSurfaceOrFaceSurface_union m_union;
    };
} // namespace ifc2x3