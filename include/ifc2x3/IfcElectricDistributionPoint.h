...
namespace ifc2x3
{
    ...
    class IFC2X3_EXPORT IfcElectricDistributionPoint : public IfcFlowController
    {
        ...
        IfcLabel m_UserDefinedFunction;
    ...
    public:
        ...
        /// Attribute DistributionPointFunction
        /// @{
        virtual IfcElectricDistributionPointFunctionEnum getDistributionPointFunction();
        virtual IfcElectricDistributionPointFunctionEnum getDistributionPointFunction() const;
