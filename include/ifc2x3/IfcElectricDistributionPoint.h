...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'DistributionPointFunction'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'UserDefinedFunction'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcElectricDistributionPoint_Factory;

  protected:
    /**
     * @param args
     */
    IfcElectricDistributionPoint(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcElectricDistributionPoint(const IfcElectricDistributionPoint &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcElectricDistributionPoint_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcElectricDistributionPoint_Factory();
    virtual ~IfcElectricDistributionPoint_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcElectricDistributionPoint *get(Step::StepId id);
    /**
     */
    IfcElectricDistributionPoint *generate();
    /**
     * @param id
     */
    IfcElectricDistributionPoint *find(Step::StepId id);
