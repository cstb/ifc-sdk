...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcOutletType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcOutletTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcOutletTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcOutletTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcOutletType(Step::Id id, Step::SPFData *args);
        ~IfcOutletType() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcOutletType &obj, const CopyOp &copyop);
