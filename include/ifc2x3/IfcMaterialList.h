...
namespace ifc2x3 {
    ...
    /**
     */
    class IFC2X3_DLL_DEF IfcMaterialList : public Step::BaseEntity {
    public:
        /**
        ...
        /**
         */
        Step::List< Step::RefPtr< IfcMaterial > > &getMaterials();
        /**
         * Sets the value of the explicit attribute 'Materials'.
         * 
         * @param value
         */
        void setMaterials(const Step::List< Step::RefPtr< IfcMaterial > > &value);
        /**
         */
    ...
    private:
        ...
        /**
         */
        Step::List< Step::RefPtr< IfcMaterial > > m_materials;
