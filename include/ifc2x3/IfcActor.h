...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual Step::RefPtr< Inverse_Set_IfcRelAssignsToActor_0_n > &getIsActingUpon();
        /**
         * (const) Returns the value of the explicit attribute 'IsActingUpon'.
         * 
         * @return the value of the explicit attribute 'IsActingUpon'
         */
        const virtual Step::RefPtr< Inverse_Set_IfcRelAssignsToActor_0_n > &getIsActingUpon() const;
        /**
