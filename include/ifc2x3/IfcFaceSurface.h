...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'FaceSurface'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcFaceSurface_Factory;

  protected:
    /**
     * @param args
     */
    IfcFaceSurface(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcFaceSurface(const IfcFaceSurface &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcFaceSurface_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcFaceSurface_Factory();
    virtual ~IfcFaceSurface_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcFaceSurface *get(Step::StepId id);
    /**
     */
    IfcFaceSurface *generate();
    /**
     * @param id
     */
    IfcFaceSurface *find(Step::StepId id);
