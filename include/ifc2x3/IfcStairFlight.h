...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcStairFlight : public Step::InstantiatableEntity, public IfcBuildingElement {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'NumberOfRiser'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'NumberOfTreads'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'RiserHeight'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'TreadLength'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcStairFlight_Factory;

  protected:
    /**
     * @param args
     */
    IfcStairFlight(Step::SPFData *args);
    virtual ~IfcStairFlight();

  private:
    static Step::ClassType s_type;
    Integer m_numberOfRiser;
    Integer m_numberOfTreads;
    Real m_riserHeight;
    Real m_treadLength;
    /**
     * @param c
     */
    IfcStairFlight(const IfcStairFlight &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcStairFlight_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcStairFlight_Factory();
    virtual ~IfcStairFlight_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcStairFlight *get(Step::StepId id);
    /**
     */
    IfcStairFlight *generate();
    /**
     * @param id
     */
    IfcStairFlight *find(Step::StepId id);
