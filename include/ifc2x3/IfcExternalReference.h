...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcExternalReference : public Step::BaseObject {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'Location'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'ItemReference'.
     * 
  ...
  protected:
     ...
     * @param args
     */
    IfcExternalReference(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcExternalReference(const IfcExternalReference &c);
