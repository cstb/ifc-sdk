...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcStructuralConnectionCondition : public Step::BaseObject {
  public:
    /**
  ...
  protected:
     ...
     * @param args
     */
    IfcStructuralConnectionCondition(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcStructuralConnectionCondition(const IfcStructuralConnectionCondition &c);
