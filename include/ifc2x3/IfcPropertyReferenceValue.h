...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual IfcObjectReferenceSelect *getPropertyReference();
        /**
         * (const) Returns the value of the explicit attribute 'PropertyReference'.
         * 
         * @return the value of the explicit attribute 'PropertyReference'
         */
        virtual const IfcObjectReferenceSelect *getPropertyReference() const;
        /**
    ...
    protected:
        ...
        ~IfcPropertyReferenceValue() override;
        /**
         */
        bool init() override;
        /**
