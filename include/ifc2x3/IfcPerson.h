...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual Step::RefPtr< Inverse_Set_IfcPersonAndOrganization_0_n > &getEngagedIn();
        /**
         * (const) Returns the value of the explicit attribute 'EngagedIn'.
         * 
         * @return the value of the explicit attribute 'EngagedIn'
         */
        const virtual Step::RefPtr< Inverse_Set_IfcPersonAndOrganization_0_n > &getEngagedIn() const;
        /**
