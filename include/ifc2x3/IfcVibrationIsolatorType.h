...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcVibrationIsolatorType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcVibrationIsolatorTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcVibrationIsolatorTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcVibrationIsolatorTypeEnum value);
        /**
    ...
    protected:
        ...
        ~IfcVibrationIsolatorType() override;
        /**
         */
        bool init() override;
        /**
