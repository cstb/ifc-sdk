...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcVibrationIsolatorType_Factory;

  protected:
    /**
     * @param args
     */
    IfcVibrationIsolatorType(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcVibrationIsolatorType(const IfcVibrationIsolatorType &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcVibrationIsolatorType_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcVibrationIsolatorType_Factory();
    virtual ~IfcVibrationIsolatorType_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcVibrationIsolatorType *get(Step::StepId id);
    /**
     */
    IfcVibrationIsolatorType *generate();
    /**
     * @param id
     */
    IfcVibrationIsolatorType *find(Step::StepId id);
