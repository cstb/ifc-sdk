...
namespace ifc2x3 {
    ...
    public:
        ...
        /**
         */
        Step::List< Step::RefPtr< IfcSurfaceTexture > > &getTextures();
        /**
         * Sets the value of the explicit attribute 'Textures'.
         * 
         * @param value
         */
        void setTextures(const Step::List< Step::RefPtr< IfcSurfaceTexture > > &value);
        /**
         */
    ...
    private:
        ...
        /**
         */
        Step::List< Step::RefPtr< IfcSurfaceTexture > > m_textures;
