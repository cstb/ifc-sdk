...
namespace ifc2x3 {
  ...
  public:
     ...
     * @param value
     */
    void setRelatingDocument(const Step::RefPtr< IfcDocumentSelect > &value);
    /**
     */
     ...
     */
    virtual bool init();
    friend class IfcRelAssociatesDocument_Factory;

  protected:
    /**
     * @param args
     */
    IfcRelAssociatesDocument(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcRelAssociatesDocument(const IfcRelAssociatesDocument &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRelAssociatesDocument_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcRelAssociatesDocument_Factory();
    virtual ~IfcRelAssociatesDocument_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcRelAssociatesDocument *get(Step::StepId id);
    /**
     */
    IfcRelAssociatesDocument *generate();
    /**
     * @param id
     */
    IfcRelAssociatesDocument *find(Step::StepId id);
