...
{
    /**
     * Generated class for the IfcConditionCriterionSelect Select type.
     *
     */
    class IFC2X3_EXPORT IfcConditionCriterionSelect : public Step::BaseObject
    ...
    private:
        ...
        IfcConditionCriterionSelect_union m_union;
    };
} // namespace ifc2x3