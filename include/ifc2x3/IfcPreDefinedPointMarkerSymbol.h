...
namespace ifc2x3 {
    ...
    protected:
         ...
         * @param args
         */
        IfcPreDefinedPointMarkerSymbol(Step::Id id, Step::SPFData *args);
        ~IfcPreDefinedPointMarkerSymbol() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcPreDefinedPointMarkerSymbol &obj, const CopyOp &copyop);
...
#endif // IFC2X3_IFCPREDEFINEDPOINTMARKERSYMBOL_H
