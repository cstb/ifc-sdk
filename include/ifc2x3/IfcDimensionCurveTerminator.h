...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcDimensionCurveTerminator_Factory;

  protected:
    /**
     * @param args
     */
    IfcDimensionCurveTerminator(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcDimensionCurveTerminator(const IfcDimensionCurveTerminator &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcDimensionCurveTerminator_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcDimensionCurveTerminator_Factory();
    virtual ~IfcDimensionCurveTerminator_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcDimensionCurveTerminator *get(Step::StepId id);
    /**
     */
    IfcDimensionCurveTerminator *generate();
    /**
     * @param id
     */
    IfcDimensionCurveTerminator *find(Step::StepId id);
