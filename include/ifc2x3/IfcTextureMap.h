...
namespace ifc2x3 {
    ...
    public:
        ...
        /**
         */
        Step::Set< Step::RefPtr< IfcVertexBasedTextureMap > > &getTextureMaps();
        /**
         * Sets the value of the explicit attribute 'TextureMaps'.
         * 
         * @param value
         */
        void setTextureMaps(const Step::Set< Step::RefPtr< IfcVertexBasedTextureMap > > &value);
        /**
         */
    ...
    private:
        ...
        /**
         */
        Step::Set< Step::RefPtr< IfcVertexBasedTextureMap > > m_textureMaps;
