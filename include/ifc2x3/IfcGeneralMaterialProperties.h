...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcGeneralMaterialProperties : public Step::InstantiatableEntity, public IfcMaterialProperties {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'MolecularWeight'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'Porosity'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'MassDensity'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcGeneralMaterialProperties_Factory;

  protected:
    /**
     * @param args
     */
    IfcGeneralMaterialProperties(Step::SPFData *args);
    virtual ~IfcGeneralMaterialProperties();

  private:
    static Step::ClassType s_type;
    Real m_molecularWeight;
    Real m_porosity;
    Real m_massDensity;
    /**
     * @param c
     */
    IfcGeneralMaterialProperties(const IfcGeneralMaterialProperties &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcGeneralMaterialProperties_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcGeneralMaterialProperties_Factory();
    virtual ~IfcGeneralMaterialProperties_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcGeneralMaterialProperties *get(Step::StepId id);
    /**
     */
    IfcGeneralMaterialProperties *generate();
    /**
     * @param id
     */
    IfcGeneralMaterialProperties *find(Step::StepId id);
