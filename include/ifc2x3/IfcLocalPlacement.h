...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcLocalPlacement : public Step::InstantiatableEntity, public IfcObjectPlacement {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'PlacementRelTo'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'RelativePlacement'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcLocalPlacement_Factory;

  protected:
    /**
     * @param args
     */
    IfcLocalPlacement(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcLocalPlacement(const IfcLocalPlacement &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcLocalPlacement_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcLocalPlacement_Factory();
    virtual ~IfcLocalPlacement_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcLocalPlacement *get(Step::StepId id);
    /**
     */
    IfcLocalPlacement *generate();
    /**
     * @param id
     */
    IfcLocalPlacement *find(Step::StepId id);
