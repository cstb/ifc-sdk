...
namespace ifc2x3 {
    ...
    public:
         ...
         */
        virtual Step::RefPtr< Inverse_Set_IfcProduct_1_n > &getPlacesObject();
        /**
         * (const) Returns the value of the explicit attribute 'PlacesObject'.
         * 
         * @return the value of the explicit attribute 'PlacesObject'
         */
        const virtual Step::RefPtr< Inverse_Set_IfcProduct_1_n > &getPlacesObject() const;
        /**
         ...
         * 
         */
        virtual Step::RefPtr< Inverse_Set_IfcLocalPlacement_0_n > &getReferencedByPlacements();
        /**
         ...
         */
        const virtual Step::RefPtr< Inverse_Set_IfcLocalPlacement_0_n > &getReferencedByPlacements() const;
        /**
