...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcFireSuppressionTerminalType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcFireSuppressionTerminalTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcFireSuppressionTerminalTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcFireSuppressionTerminalTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcFireSuppressionTerminalType(Step::Id id, Step::SPFData *args);
        ~IfcFireSuppressionTerminalType() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcFireSuppressionTerminalType &obj, const CopyOp &copyop);
