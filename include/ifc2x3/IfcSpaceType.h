...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcSpaceType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcSpaceTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcSpaceTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcSpaceTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcSpaceType(Step::Id id, Step::SPFData *args);
         ...
         * @param copyop
         */
        virtual void copy(const IfcSpaceType &obj, const CopyOp &copyop);
