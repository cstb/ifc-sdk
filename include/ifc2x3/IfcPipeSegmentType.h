...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcPipeSegmentType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcPipeSegmentTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcPipeSegmentTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcPipeSegmentTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcPipeSegmentType(Step::Id id, Step::SPFData *args);
         ...
         * @param copyop
         */
        virtual void copy(const IfcPipeSegmentType &obj, const CopyOp &copyop);
