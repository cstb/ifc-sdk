...
namespace ifc2x3 {
    ...
    protected:
         ...
         * @param args
         */
        IfcContextDependentUnit(Step::Id id, Step::SPFData *args);
        ~IfcContextDependentUnit() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcContextDependentUnit &obj, const CopyOp &copyop);
