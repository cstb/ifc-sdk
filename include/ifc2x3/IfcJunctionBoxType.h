...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcJunctionBoxType_Factory;

  protected:
    /**
     * @param args
     */
    IfcJunctionBoxType(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcJunctionBoxType(const IfcJunctionBoxType &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcJunctionBoxType_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcJunctionBoxType_Factory();
    virtual ~IfcJunctionBoxType_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcJunctionBoxType *get(Step::StepId id);
    /**
     */
    IfcJunctionBoxType *generate();
    /**
     * @param id
     */
    IfcJunctionBoxType *find(Step::StepId id);
