...
namespace ifc2x3
{
    ...
    class IFC2X3_EXPORT IfcSlippageConnectionCondition : public IfcStructuralConnectionCondition
    {
        ...
        // Attributes
        IfcLengthMeasure m_SlippageX;
        IfcLengthMeasure m_SlippageY;
        IfcLengthMeasure m_SlippageZ;
    ...
    public:
        ...
        virtual IfcLengthMeasure getSlippageX() const;
        ...
        virtual IfcLengthMeasure getSlippageY() const;
        ...
        virtual IfcLengthMeasure getSlippageZ() const;
