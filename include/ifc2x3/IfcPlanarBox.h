...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcPlanarBox_Factory;

  protected:
    /**
     * @param args
     */
    IfcPlanarBox(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcPlanarBox(const IfcPlanarBox &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcPlanarBox_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcPlanarBox_Factory();
    virtual ~IfcPlanarBox_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcPlanarBox *get(Step::StepId id);
    /**
     */
    IfcPlanarBox *generate();
    /**
     * @param id
     */
    IfcPlanarBox *find(Step::StepId id);
