...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcCircle Entity.
     * 
     */
    class IFC2X3_DLL_DEF IfcCircle : public IfcConic {
    public:
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcCircle(Step::Id id, Step::SPFData *args);
        virtual ~IfcCircle();
        /**
         */
        virtual bool init();
         ...
         * @param copyop
         */
        virtual void copy(const IfcCircle &obj, const CopyOp &copyop);
