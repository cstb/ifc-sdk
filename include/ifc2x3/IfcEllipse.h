...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcEllipse : public Step::InstantiatableEntity, public IfcConic {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcEllipse_Factory;

  protected:
    /**
     * @param args
     */
    IfcEllipse(Step::SPFData *args);
    virtual ~IfcEllipse();
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcEllipse_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcEllipse_Factory();
    virtual ~IfcEllipse_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcEllipse *find(Step::StepId id);
