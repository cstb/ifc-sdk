...
namespace ifc2x3
{
    ...
    class IFC2X3_EXPORT IfcEllipse : public IfcConic
    {
        ...
        // Attributes
        IfcPositiveLengthMeasure m_SemiAxis1;
        IfcPositiveLengthMeasure m_SemiAxis2;
    ...
    public:
        ...
        virtual IfcPositiveLengthMeasure getSemiAxis1() const;
        ...
        virtual IfcPositiveLengthMeasure getSemiAxis2() const;
