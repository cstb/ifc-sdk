...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcLShapeProfileDef : public Step::InstantiatableEntity, public IfcParameterizedProfileDef {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'LegSlope'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcLShapeProfileDef_Factory;

  protected:
    /**
     * @param args
     */
    IfcLShapeProfileDef(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcLShapeProfileDef(const IfcLShapeProfileDef &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcLShapeProfileDef_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcLShapeProfileDef_Factory();
    virtual ~IfcLShapeProfileDef_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcLShapeProfileDef *get(Step::StepId id);
    /**
     */
    IfcLShapeProfileDef *generate();
    /**
     * @param id
     */
    IfcLShapeProfileDef *find(Step::StepId id);
