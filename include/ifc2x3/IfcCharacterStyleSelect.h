...
{
    /**
     * Generated class for the IfcCharacterStyleSelect Select type.
     *
     */
    class IFC2X3_EXPORT IfcCharacterStyleSelect : public Step::BaseObject
    ...
    private:
        ...
        IfcCharacterStyleSelect_union m_union;
    };
} // namespace ifc2x3