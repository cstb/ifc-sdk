...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRailing : public Step::InstantiatableEntity, public IfcBuildingElement {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcRailing_Factory;

  protected:
    /**
     * @param args
     */
    IfcRailing(Step::SPFData *args);
    virtual ~IfcRailing();
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRailing_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcRailing_Factory();
    virtual ~IfcRailing_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcRailing *find(Step::StepId id);
