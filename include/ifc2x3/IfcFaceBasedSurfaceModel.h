...
namespace ifc2x3 {
    ...
    public:
        ...
        /**
         */
        Step::Set< Step::RefPtr< IfcConnectedFaceSet > > &getFbsmFaces();
        /**
         * Sets the value of the explicit attribute 'FbsmFaces'.
         * 
         * @param value
         */
        void setFbsmFaces(const Step::Set< Step::RefPtr< IfcConnectedFaceSet > > &value);
        /**
         */
    ...
    private:
        ...
        /**
         */
        Step::Set< Step::RefPtr< IfcConnectedFaceSet > > m_fbsmFaces;
