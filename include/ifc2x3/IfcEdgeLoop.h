...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcEdgeLoop_Factory;

  protected:
    /**
     * @param args
     */
    IfcEdgeLoop(Step::SPFData *args);
    virtual ~IfcEdgeLoop();
  ...
  private:
     ...
     * @param c
     */
    IfcEdgeLoop(const IfcEdgeLoop &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcEdgeLoop_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcEdgeLoop_Factory();
    virtual ~IfcEdgeLoop_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcEdgeLoop *get(Step::StepId id);
    /**
     */
    IfcEdgeLoop *generate();
    /**
     * @param id
     */
    IfcEdgeLoop *find(Step::StepId id);
