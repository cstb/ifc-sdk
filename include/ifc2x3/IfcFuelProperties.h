...
namespace ifc2x3
{
    ...
    class IFC2X3_EXPORT IfcFuelProperties : public IfcMaterialProperties
    {
        ...
        // Attributes
        IfcThermodynamicTemperatureMeasure m_CombustionTemperature;
        IfcPositiveRatioMeasure m_CarbonContent;
        IfcHeatingValueMeasure m_LowerHeatingValue;
        IfcHeatingValueMeasure m_HigherHeatingValue;
    ...
    public:
        ...
        /// Attribute CombustionTemperature
        /// @{
        virtual IfcThermodynamicTemperatureMeasure getCombustionTemperature();
        virtual IfcThermodynamicTemperatureMeasure getCombustionTemperature() const;
        ...
        /// Attribute CarbonContent
        /// @{
        virtual IfcPositiveRatioMeasure getCarbonContent();
        virtual IfcPositiveRatioMeasure getCarbonContent() const;
        ...
        /// Attribute LowerHeatingValue
        /// @{
        virtual IfcHeatingValueMeasure getLowerHeatingValue();
        virtual IfcHeatingValueMeasure getLowerHeatingValue() const;
        ...
        /// Attribute HigherHeatingValue
        /// @{
        virtual IfcHeatingValueMeasure getHigherHeatingValue();
        virtual IfcHeatingValueMeasure getHigherHeatingValue() const;
