...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcAxis2Placement2D : public Step::InstantiatableEntity, public IfcPlacement {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcAxis2Placement2D_Factory;

  protected:
    /**
     * @param args
     */
    IfcAxis2Placement2D(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcAxis2Placement2D(const IfcAxis2Placement2D &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcAxis2Placement2D_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcAxis2Placement2D_Factory();
    virtual ~IfcAxis2Placement2D_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcAxis2Placement2D *get(Step::StepId id);
    /**
     */
    IfcAxis2Placement2D *generate();
    /**
     * @param id
     */
    IfcAxis2Placement2D *find(Step::StepId id);
