...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual Step::RefPtr< Inverse_Set_IfcRelConnectsStructuralMember_1_n > &getConnectsStructuralMembers();
        /**
         ...
         */
        const virtual Step::RefPtr< Inverse_Set_IfcRelConnectsStructuralMember_1_n > &getConnectsStructuralMembers() const;
        /**
