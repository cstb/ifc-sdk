...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'PolygonalBoundary'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcPolygonalBoundedHalfSpace_Factory;

  protected:
    /**
     * @param args
     */
    IfcPolygonalBoundedHalfSpace(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcPolygonalBoundedHalfSpace(const IfcPolygonalBoundedHalfSpace &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcPolygonalBoundedHalfSpace_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcPolygonalBoundedHalfSpace_Factory();
    virtual ~IfcPolygonalBoundedHalfSpace_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcPolygonalBoundedHalfSpace *get(Step::StepId id);
    /**
     */
    IfcPolygonalBoundedHalfSpace *generate();
    /**
     * @param id
     */
    IfcPolygonalBoundedHalfSpace *find(Step::StepId id);
