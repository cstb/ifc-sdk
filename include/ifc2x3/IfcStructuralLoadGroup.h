...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual Step::RefPtr< Inverse_Set_IfcStructuralResultGroup_0_1 > &getSourceOfResultGroup();
        /**
         ...
         */
        const virtual Step::RefPtr< Inverse_Set_IfcStructuralResultGroup_0_1 > &getSourceOfResultGroup() const;
        /**
         ...
         * 
         */
        virtual Step::RefPtr< Inverse_Set_IfcStructuralAnalysisModel_0_n > &getLoadGroupFor();
        /**
         * (const) Returns the value of the explicit attribute 'LoadGroupFor'.
         * 
         * @return the value of the explicit attribute 'LoadGroupFor'
         */
        const virtual Step::RefPtr< Inverse_Set_IfcStructuralAnalysisModel_0_n > &getLoadGroupFor() const;
        /**
