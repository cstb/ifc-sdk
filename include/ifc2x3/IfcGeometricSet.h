...
namespace ifc2x3 {
    ...
    /**
     */
    class IFC2X3_DLL_DEF IfcGeometricSet : public IfcGeometricRepresentationItem {
    public:
        /**
        ...
        /**
         */
        Step::Set< Step::RefPtr< IfcGeometricSetSelect > > &getElements();
        /**
         * Sets the value of the explicit attribute 'Elements'.
         * 
         * @param value
         */
        void setElements(const Step::Set< Step::RefPtr< IfcGeometricSetSelect > > &value);
        /**
         */
    ...
    private:
        ...
        /**
         */
        Step::Set< Step::RefPtr< IfcGeometricSetSelect > > m_elements;
