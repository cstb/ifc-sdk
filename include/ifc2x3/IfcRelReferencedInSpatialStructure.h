...
namespace ifc2x3 {
     ...
     * 
     */
    class Inverted_IfcRelReferencedInSpatialStructure_RelatedElements_type : public Set_IfcProduct_1_n {
    public:
        /**
         */
        ...
        /**
         */
        Inverted_IfcRelReferencedInSpatialStructure_RelatedElements_type();
        /**
         * Insert a value in the aggregate.
         * 
         * @param value The object to act upon.
         */
        void insert(const Step::RefPtr< IfcProduct > &value) throw(std::out_of_range) override;
        /**
         * Remove a value from the aggregate.
         * 
         * @param value The object to act upon.
         */
        size_type erase(const Step::RefPtr< IfcProduct > &value) override;
        /**
    ...
    protected:
         ...
         * 
         */
        IfcRelReferencedInSpatialStructure *mOwner;
        /**
         * @param owner The owner of this inverted aggregate.
         */
        void setOwner(IfcRelReferencedInSpatialStructure *owner);
    ...
    /**
     * Generated class for the IfcRelReferencedInSpatialStructure Entity.
     * 
     */
    ...
    protected:
         ...
         * @param args
         */
        IfcRelReferencedInSpatialStructure(Step::Id id, Step::SPFData *args);
        ~IfcRelReferencedInSpatialStructure() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcRelReferencedInSpatialStructure &obj, const CopyOp &copyop);
    ...
    private:
        ...
        /**
         */
        Inverted_IfcRelReferencedInSpatialStructure_RelatedElements_type m_relatedElements;
        /**
         */
