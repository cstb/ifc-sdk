...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRepresentationItem : public Step::BaseObject {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'StyledByItem'.
     * 
     * @return the value of the explicit attribute 'StyledByItem'
     */
    Step::StepSet< Step::RefPtr< IfcStyledItem > > &getStyledByItem();
    /**
     * Sets the value of the explicit attribute 'StyledByItem'.
     * 
     * @param value
     */
    void setStyledByItem(const Step::StepSet< Step::RefPtr< IfcStyledItem > > &value);
    /**
     */
  ...
  protected:
     ...
     * @param args
     */
    IfcRepresentationItem(Step::SPFData *args);
    virtual ~IfcRepresentationItem();

  private:
    static Step::ClassType s_type;
    Step::StepSet< Step::RefPtr< IfcPresentationLayerAssignment > > m_layerAssignments;
    Step::StepSet< Step::RefPtr< IfcStyledItem > > m_styledByItem;
    /**
     * @param c
     */
    IfcRepresentationItem(const IfcRepresentationItem &c);
