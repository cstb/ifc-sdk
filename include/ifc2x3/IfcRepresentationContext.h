...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual Step::RefPtr< Inverse_Set_IfcRepresentation_0_n > &getRepresentationsInContext();
        /**
         ...
         */
        const virtual Step::RefPtr< Inverse_Set_IfcRepresentation_0_n > &getRepresentationsInContext() const;
        /**
