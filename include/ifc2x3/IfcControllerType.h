...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcControllerType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcControllerTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcControllerTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcControllerTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcControllerType(Step::Id id, Step::SPFData *args);
        ~IfcControllerType() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcControllerType &obj, const CopyOp &copyop);
