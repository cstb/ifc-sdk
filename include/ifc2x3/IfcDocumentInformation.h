...
namespace ifc2x3 {
    ...
    public:
         ...
         */
        void insert(const Step::RefPtr< IfcDocumentReference > &value) throw(std::out_of_range) override;
        /**
         * Remove a value from the aggregate.
         * 
         * @param value The object to act upon.
         */
        size_type erase(const Step::RefPtr< IfcDocumentReference > &value) override;
        /**
    ...
    protected:
        ...
        ~IfcDocumentInformation() override;
        /**
         */
        bool init() override;
        /**
