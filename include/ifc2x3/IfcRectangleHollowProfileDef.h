...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'InnerFilletRadius'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'OuterFilletRadius'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcRectangleHollowProfileDef_Factory;

  protected:
    /**
     * @param args
     */
    IfcRectangleHollowProfileDef(Step::SPFData *args);
    virtual ~IfcRectangleHollowProfileDef();

  private:
    static Step::ClassType s_type;
    Real m_wallThickness;
    Real m_innerFilletRadius;
    Real m_outerFilletRadius;
    /**
     * @param c
     */
    IfcRectangleHollowProfileDef(const IfcRectangleHollowProfileDef &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcRectangleHollowProfileDef_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcRectangleHollowProfileDef_Factory();
    virtual ~IfcRectangleHollowProfileDef_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcRectangleHollowProfileDef *get(Step::StepId id);
    /**
     */
    IfcRectangleHollowProfileDef *generate();
    /**
     * @param id
     */
    IfcRectangleHollowProfileDef *find(Step::StepId id);
