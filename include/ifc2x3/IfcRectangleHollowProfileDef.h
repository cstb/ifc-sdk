...
namespace ifc2x3
{
    ...
    class IFC2X3_EXPORT IfcRectangleHollowProfileDef : public IfcRectangleProfileDef
    {
        ...
        IfcPositiveLengthMeasure m_InnerFilletRadius;
        IfcPositiveLengthMeasure m_OuterFilletRadius;
    ...
    public:
        ...
        /// Attribute InnerFilletRadius
        /// @{
        virtual IfcPositiveLengthMeasure getInnerFilletRadius();
        virtual IfcPositiveLengthMeasure getInnerFilletRadius() const;
        ...
        /// Attribute OuterFilletRadius
        /// @{
        virtual IfcPositiveLengthMeasure getOuterFilletRadius();
        virtual IfcPositiveLengthMeasure getOuterFilletRadius() const;
