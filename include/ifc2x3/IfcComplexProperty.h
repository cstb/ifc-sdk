...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcComplexProperty : public Step::InstantiatableEntity, public IfcProperty {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcComplexProperty_Factory;

  protected:
    /**
     * @param args
     */
    IfcComplexProperty(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcComplexProperty(const IfcComplexProperty &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcComplexProperty_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcComplexProperty_Factory();
    virtual ~IfcComplexProperty_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcComplexProperty *get(Step::StepId id);
    /**
     */
    IfcComplexProperty *generate();
    /**
     * @param id
     */
    IfcComplexProperty *find(Step::StepId id);
