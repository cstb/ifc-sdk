...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcPile : public Step::InstantiatableEntity, public IfcBuildingElement {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcPile_Factory;

  protected:
    /**
     * @param args
     */
    IfcPile(Step::SPFData *args);
    virtual ~IfcPile();
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcPile_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcPile_Factory();
    virtual ~IfcPile_Factory();
    /**
     * @param b
     */
    void clear(bool b);
