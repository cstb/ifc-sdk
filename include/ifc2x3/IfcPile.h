...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcPile Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcPileTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcPileTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcPileTypeEnum value);
        /**
         ...
         * 
         */
        virtual IfcPileConstructionEnum getConstructionType();
        /**
         ...
         */
        virtual const IfcPileConstructionEnum getConstructionType() const;
        /**
         * Sets the value of the explicit attribute 'ConstructionType'.
         * 
         * @param value
         */
        virtual void setConstructionType(IfcPileConstructionEnum value);
        /**
