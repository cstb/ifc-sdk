...
namespace ifc2x3 {
    ...
    public:
        ...
        /**
         */
        Step::Set< Step::RefPtr< IfcFillStyleSelect > > &getFillStyles();
        /**
         * Sets the value of the explicit attribute 'FillStyles'.
         * 
         * @param value
         */
        void setFillStyles(const Step::Set< Step::RefPtr< IfcFillStyleSelect > > &value);
        /**
         */
    ...
    private:
        ...
        /**
         */
        Step::Set< Step::RefPtr< IfcFillStyleSelect > > m_fillStyles;
