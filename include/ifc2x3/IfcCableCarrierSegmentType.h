...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcCableCarrierSegmentType : public IfcFlowSegmentType {
  public:
    /**
     ...
     */
    virtual bool init();
    friend class IfcCableCarrierSegmentType_Factory;

  protected:
    /**
     * @param args
     */
    IfcCableCarrierSegmentType(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcCableCarrierSegmentType(const IfcCableCarrierSegmentType &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcCableCarrierSegmentType_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcCableCarrierSegmentType_Factory();
    virtual ~IfcCableCarrierSegmentType_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcCableCarrierSegmentType *get(Step::StepId id);
    /**
     */
    IfcCableCarrierSegmentType *generate();
    /**
     * @param id
     */
    IfcCableCarrierSegmentType *find(Step::StepId id);
