...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcAnnotationSurfaceOccurrence Entity.
     * 
     */
    ...
    protected:
         ...
         * @param args
         */
        IfcAnnotationSurfaceOccurrence(Step::Id id, Step::SPFData *args);
        ~IfcAnnotationSurfaceOccurrence() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcAnnotationSurfaceOccurrence &obj, const CopyOp &copyop);
