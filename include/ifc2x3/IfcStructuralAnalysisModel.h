...
namespace ifc2x3 {
    ...
    public:
         ...
         */
        void insert(const Step::RefPtr< IfcStructuralLoadGroup > &value) throw(std::out_of_range) override;
        /**
         * Remove a value from the aggregate.
         * 
         * @param value The object to act upon.
         */
        size_type erase(const Step::RefPtr< IfcStructuralLoadGroup > &value) override;
        /**
    ...
    public:
         ...
         * @param value The object to act upon.
         */
        void insert(const Step::RefPtr< IfcStructuralResultGroup > &value) throw(std::out_of_range) override;
        /**
         * Remove a value from the aggregate.
         * 
         * @param value The object to act upon.
         */
        size_type erase(const Step::RefPtr< IfcStructuralResultGroup > &value) override;
        /**
         * Remove all values from the aggregate.
         * 
         */
    ...
    protected:
        ...
        ~IfcStructuralAnalysisModel() override;
        /**
         */
        bool init() override;
        /**
