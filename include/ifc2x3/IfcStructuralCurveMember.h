...
namespace ifc2x3 {
    ...
    public:
         ...
         * 
         */
        virtual IfcStructuralCurveTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcStructuralCurveTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcStructuralCurveTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcStructuralCurveMember(Step::Id id, Step::SPFData *args);
        ~IfcStructuralCurveMember() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcStructuralCurveMember &obj, const CopyOp &copyop);
