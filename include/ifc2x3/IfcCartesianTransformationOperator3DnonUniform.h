...
namespace ifc2x3 {
  ...
  public:
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'Scale3'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcCartesianTransformationOperator3DnonUniform_Factory;

  protected:
    /**
     * @param args
     */
    IfcCartesianTransformationOperator3DnonUniform(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcCartesianTransformationOperator3DnonUniform(const IfcCartesianTransformationOperator3DnonUniform &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcCartesianTransformationOperator3DnonUniform_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcCartesianTransformationOperator3DnonUniform_Factory();
    virtual ~IfcCartesianTransformationOperator3DnonUniform_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcCartesianTransformationOperator3DnonUniform *get(Step::StepId id);
    /**
     */
    IfcCartesianTransformationOperator3DnonUniform *generate();
    /**
     * @param id
     */
    IfcCartesianTransformationOperator3DnonUniform *find(Step::StepId id);
