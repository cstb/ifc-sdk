...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcVector : public Step::InstantiatableEntity, public IfcGeometricRepresentationItem {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'Magnitude'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcVector_Factory;

  protected:
    /**
     * @param args
     */
    IfcVector(Step::SPFData *args);
    virtual ~IfcVector();
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcVector_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcVector_Factory();
    virtual ~IfcVector_Factory();
    /**
     * @param b
     */
    void clear(bool b);
