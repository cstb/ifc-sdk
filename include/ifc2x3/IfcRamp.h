...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcRamp Entity.
     * 
     */
    class IFC2X3_DLL_DEF IfcRamp : public IfcBuildingElement {
    public:
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcRamp(Step::Id id, Step::SPFData *args);
        virtual ~IfcRamp();
        /**
         */
        virtual bool init();
         ...
         * @param copyop
         */
        virtual void copy(const IfcRamp &obj, const CopyOp &copyop);
