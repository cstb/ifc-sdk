...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcAirTerminalType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcAirTerminalTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcAirTerminalTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcAirTerminalTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcAirTerminalType(Step::Id id, Step::SPFData *args);
        ~IfcAirTerminalType() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcAirTerminalType &obj, const CopyOp &copyop);
