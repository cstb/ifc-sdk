...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcAlarmType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcAlarmTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcAlarmTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcAlarmTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcAlarmType(Step::Id id, Step::SPFData *args);
        ~IfcAlarmType() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcAlarmType &obj, const CopyOp &copyop);
