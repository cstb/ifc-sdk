...
namespace ifc2x3
{
    ...
    class IFC2X3_EXPORT IfcBuilding : public IfcSpatialStructureElement
    {
        ...
        // Attributes
        IfcLengthMeasure m_ElevationOfRefHeight;
        IfcLengthMeasure m_ElevationOfTerrain;
    ...
    public:
        ...
        /// Attribute ElevationOfRefHeight
        /// @{
        virtual IfcLengthMeasure getElevationOfRefHeight();
        virtual IfcLengthMeasure getElevationOfRefHeight() const;
        ...
        /// Attribute ElevationOfTerrain
        /// @{
        virtual IfcLengthMeasure getElevationOfTerrain();
        virtual IfcLengthMeasure getElevationOfTerrain() const;
