...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcBuilding : public Step::InstantiatableEntity, public IfcSpatialStructureElement {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'ElevationOfRefHeight'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'ElevationOfTerrain'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'BuildingAddress'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcBuilding_Factory;

  protected:
    /**
     * @param args
     */
    IfcBuilding(Step::SPFData *args);
    virtual ~IfcBuilding();

  private:
    static Step::ClassType s_type;
    Real m_elevationOfRefHeight;
    Real m_elevationOfTerrain;
    Step::RefPtr< IfcPostalAddress > m_buildingAddress;
    /**
     * @param c
     */
    IfcBuilding(const IfcBuilding &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcBuilding_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcBuilding_Factory();
    virtual ~IfcBuilding_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcBuilding *get(Step::StepId id);
    /**
     */
    IfcBuilding *generate();
    /**
     * @param id
     */
    IfcBuilding *find(Step::StepId id);
