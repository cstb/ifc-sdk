...
namespace ifc2x3 {
    ...
    public:
        ...
        /**
         */
        Step::List< Step::RefPtr< IfcCartesianPoint > > &getPolygon();
        /**
         * Sets the value of the explicit attribute 'Polygon'.
         * 
         * @param value
         */
        void setPolygon(const Step::List< Step::RefPtr< IfcCartesianPoint > > &value);
        /**
         */
    ...
    private:
        ...
        /**
         */
        Step::List< Step::RefPtr< IfcCartesianPoint > > m_polygon;
