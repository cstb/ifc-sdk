...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcFilterType Entity.
     * 
     */
    ...
    public:
         ...
         * 
         */
        virtual IfcFilterTypeEnum getPredefinedType();
        /**
         ...
         */
        virtual const IfcFilterTypeEnum getPredefinedType() const;
        /**
         * Sets the value of the explicit attribute 'PredefinedType'.
         * 
         * @param value
         */
        virtual void setPredefinedType(IfcFilterTypeEnum value);
        /**
    ...
    protected:
         ...
         * @param args
         */
        IfcFilterType(Step::Id id, Step::SPFData *args);
         ...
         * @param copyop
         */
        virtual void copy(const IfcFilterType &obj, const CopyOp &copyop);
