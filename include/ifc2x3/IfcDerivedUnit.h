...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcDerivedUnit : public Step::InstantiatableEntity, public Step::BaseObject {
  public:
    /**
     ...
     */
    Step::StepSet< Step::RefPtr< IfcDerivedUnitElement > > &getElements();
    /**
     * Sets the value of the explicit attribute 'Elements'.
     * 
     * @param value
     */
    void setElements(const Step::StepSet< Step::RefPtr< IfcDerivedUnitElement > > &value);
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'UserDefinedType'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcDerivedUnit_Factory;

  protected:
    /**
     * @param args
     */
    IfcDerivedUnit(Step::SPFData *args);
    virtual ~IfcDerivedUnit();

  private:
    static Step::ClassType s_type;
    Step::StepSet< Step::RefPtr< IfcDerivedUnitElement > > m_elements;
    IfcDerivedUnitEnum m_unitType;
    std::string m_userDefinedType;
    /**
     * @param c
     */
    IfcDerivedUnit(const IfcDerivedUnit &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcDerivedUnit_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcDerivedUnit_Factory();
    virtual ~IfcDerivedUnit_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcDerivedUnit *get(Step::StepId id);
    /**
     */
    IfcDerivedUnit *generate();
    /**
     * @param id
     */
    IfcDerivedUnit *find(Step::StepId id);
