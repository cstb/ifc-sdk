...
namespace ifc2x3 {
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcBoundaryEdgeCondition : public Step::InstantiatableEntity, public IfcBoundaryCondition {
  public:
    /**
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'LinearStiffnessByLengthX'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'LinearStiffnessByLengthY'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'LinearStiffnessByLengthZ'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'RotationalStiffnessByLengthX'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'RotationalStiffnessByLengthY'.
     * 
    ...
    /**
     * (non-const) Returns the value of the explicit attribute 'RotationalStiffnessByLengthZ'.
     * 
     ...
     */
    virtual bool init();
    friend class IfcBoundaryEdgeCondition_Factory;

  protected:
    /**
     * @param args
     */
    IfcBoundaryEdgeCondition(Step::SPFData *args);
    virtual ~IfcBoundaryEdgeCondition();

  private:
    static Step::ClassType s_type;
    Real m_linearStiffnessByLengthX;
    Real m_linearStiffnessByLengthY;
    Real m_linearStiffnessByLengthZ;
    Real m_rotationalStiffnessByLengthX;
    Real m_rotationalStiffnessByLengthY;
    Real m_rotationalStiffnessByLengthZ;
    /**
     * @param c
     */
    IfcBoundaryEdgeCondition(const IfcBoundaryEdgeCondition &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcBoundaryEdgeCondition_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcBoundaryEdgeCondition_Factory();
    virtual ~IfcBoundaryEdgeCondition_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcBoundaryEdgeCondition *get(Step::StepId id);
    /**
     */
    IfcBoundaryEdgeCondition *generate();
    /**
     * @param id
     */
    IfcBoundaryEdgeCondition *find(Step::StepId id);
