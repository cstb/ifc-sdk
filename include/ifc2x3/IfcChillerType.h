...
namespace ifc2x3 {
  ...
  public:
     ...
     */
    virtual bool init();
    friend class IfcChillerType_Factory;

  protected:
    /**
     * @param args
     */
    IfcChillerType(Step::SPFData *args);
  ...
  private:
     ...
     * @param c
     */
    IfcChillerType(const IfcChillerType &c);
  ...
  /**
   */
  class IFC2X3_DLL_DEF IfcChillerType_Factory : public Step::BaseFactory {
  public:
    /**
     */
    explicit IfcChillerType_Factory();
    virtual ~IfcChillerType_Factory();
    /**
     * @param b
     */
    void clear(bool b);
     ...
     * @param id
     */
    IfcChillerType *get(Step::StepId id);
    /**
     */
    IfcChillerType *generate();
    /**
     * @param id
     */
    IfcChillerType *find(Step::StepId id);
