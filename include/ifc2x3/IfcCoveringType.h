...
namespace ifc2x3 {
    ...
    /**
     * Generated class for the IfcCoveringType Entity.
     * 
     */
    ...
    protected:
         ...
         * @param args
         */
        IfcCoveringType(Step::Id id, Step::SPFData *args);
         ...
         * @param copyop
         */
        virtual void copy(const IfcCoveringType &obj, const CopyOp &copyop);
