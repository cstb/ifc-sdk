...
namespace ifc2x3 {
    ...
    protected:
         ...
         * @param args
         */
        IfcAnnotationOccurrence(Step::Id id, Step::SPFData *args);
        ~IfcAnnotationOccurrence() override;
        /**
         */
        bool init() override;
        /**
         ...
         * @param copyop
         */
        virtual void copy(const IfcAnnotationOccurrence &obj, const CopyOp &copyop);
...
#endif // IFC2X3_IFCANNOTATIONOCCURRENCE_H
