 ...
 ***************************************************************************
*/
#ifndef STEP_SPF_FUNCTIONS
#define STEP_SPF_FUNCTIONS
...
namespace Step {
    ...
    */
    bool STEP_DLL_DEF getLine(std::istream& ifs, unsigned int& counter,char* buffer, unsigned long bufferLength, std::string& str);
    ...
    @return success or failure
    */
    bool STEP_DLL_DEF parseList(const char* buffer,std::vector<std::string>& res);
    ...
    */
    ...
    @return success or failure
    */
    bool STEP_DLL_DEF getIdListParam(const std::string& s, std::vector<Id>& res);
    /*!
