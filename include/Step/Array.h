...
namespace Step {
    ...
    */
    ...
    public:
        ...
        /// constructors
        //@{
        Array(bool unset=false): Aggregate(unset) {}
        ...
        reference at(size_type i) {
            checkRange(i); return _values[i-_lo];
        }
    ...
    /// UNSET for ARRAY
    template<typename T,Integer _lo, Integer _hi> inline Array<T,_lo,_hi> &getUnset(Array<T,_lo,_hi>) {
