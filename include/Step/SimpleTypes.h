 ...
 ***************************************************************************
*/
#ifndef STEP_SIMPLETYPE_H
#define STEP_SIMPLETYPE_H
...
namespace Step {
    ...
    //! Boolean type
    enum Boolean { BUnset, BFalse, BTrue };

    //! Logical type
    enum Logical { LUnset, LFalse, LTrue, LUnknown };
    ...
    */
    ...
    public:
        ...
        */
        Aggregate(bool b = false) : m_unset(b) {}
        ...
        */
        bool toggleUnset() {
            m_unset = !m_unset; return m_unset;
        }
