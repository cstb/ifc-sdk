...
int main(int n, char **p)
{
	...
	StructuralPlanarActionVarying->getSubsequentAppliedLoads().push_back(StructuralLoad1);
	...
	StructuralPlanarActionVarying->getSubsequentAppliedLoads().push_back(StructuralLoad2);
	...
	StructuralPlanarActionVarying->getSubsequentAppliedLoads().push_back(StructuralLoad3);
	...
	StructuralPlanarActionVarying->getSubsequentAppliedLoads().push_back(StructuralLoad4);
	...
	StructuralPlanarActionVarying->getSubsequentAppliedLoads().push_back(StructuralLoad5);
	...
	StructuralPlanarActionVarying->setAppliedLoad(StructuralAppliedLoad);
