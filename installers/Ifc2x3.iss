...
#define MyAppName "C++ IFC2X3 API"
#define MyAppVerName "C++ IFC2X3 API 0.3.0"
#define MyAppPublisher "CSTB TIDS MOD-EVE by Geoffrey Arthaud"
...
OutputBaseFilename=ifc2x3-install-0.3.0-vs2005
...
Source: ..\lib\Debug\ifc2x3.pdb; DestDir: {app}\bin; Flags: ignoreversion; Components: Debug
